...
7. **Produzir até o acabamento, pela dimensão mais baixa.** Quando o recorte já
   ...
   **`start <projeto>`** cria se o destino estiver livre e devolve
   ...
   prompt as nomeia — inclusive o cluster de uma mão, o toque e as
   queries de look e chuva, se o starter as declara. Não executa o jogo. `--idea` entra no brief
