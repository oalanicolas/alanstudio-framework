...
def game_dev_manual():
    """Contrato operacional roteado pela entrada fina da skill."""
    return (game.FRAMEWORK / "references/operations.md").read_text(encoding="utf-8")
...
""", encoding="utf-8")
    ...
    def test_documentation_names_the_same_capabilities_and_studies_the_code_has(self):
        ...
        for name in ("references/operations.md", "README.md"):
