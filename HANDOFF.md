...
**HEAD:** ver `git log -1` — vigente 0.9.883: o `feel` nomeia a fase que a receita já recusa. Fase no disco não é o dono. Sem chave `fase`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.883): **944 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.883)
