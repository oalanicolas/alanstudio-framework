...
**HEAD:** ver `git log -1` — vigente 0.9.731: o `feel` nomeia o pedido que a receita já recusa. Pedido no disco não é o land. Sem chave `pedido`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.731): **792 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.731)
