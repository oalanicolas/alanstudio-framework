...
**HEAD:** ver `git log -1` — vigente 0.9.588: o `form` do `origins` nomeia o crédito que o molde já recusa. Arquivo no disco não é a concessão. Sem chave `crédito`. Nomear não concede.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.588): **649 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.588)
