...
**HEAD:** ver `git log -1` — vigente 0.9.966: o `observations` do `feel` nomeia a confirmação que a receita já recusa. Confirmação no disco não é a previsão. Sem chave `confirmação`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.966): **1027 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.966)
