...
**HEAD:** ver `git log -1` — vigente 0.9.965: o `record` nomeia os timers que a receita já recusa. Timers no disco não é o vazamento. Sem chave `timers`. Nomear não mede.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.965): **1026 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.965)
