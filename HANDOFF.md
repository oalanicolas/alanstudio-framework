...
**HEAD:** ver `git log -1` — vigente 0.9.641: o `applied` do `roles --fill` nomeia o aplica que a receita já recusa. Cópia no disco não é mix. Sem chave `aplica`. Copiar não ouve.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.641): **702 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.641)
