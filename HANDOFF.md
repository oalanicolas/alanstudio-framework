...
**HEAD:** ver `git log -1` — vigente 0.9.439: o `art` nomeia a paleta que o sistema já recusa. Lista no disco não é contrato. Sem chave `paleta`. Nomear não observa.
...
Confirmação pendente no 0.9.439.
...
## O que o HEAD já entrega (0.9.91–0.9.439)
