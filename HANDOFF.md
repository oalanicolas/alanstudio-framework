...
**HEAD:** ver `git log -1` — vigente 0.9.1123: o feel nomeia o preserve que a receita já recusa. Preserve no disco não é o feel. Sem chave `preserve`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1123): **1184 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1123)
