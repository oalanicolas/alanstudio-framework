...
**HEAD:** ver `git log -1` — vigente 0.9.1051: o feel nomeia a nenhuma que a receita já recusa. Nenhuma no disco não é o feel. Sem chave `nenhuma`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1051): **1112 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1051)
