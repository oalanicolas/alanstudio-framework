...
**HEAD:** ver `git log -1` — vigente 0.9.604: o `declared` do `budget` nomeia a medida que a receita já recusa. Script no disco não é o quadro. Sem chave `medida`. Nomear não mede.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.604): **665 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.604)
