...
**HEAD:** ver `git log -1` — vigente 0.9.1085: o record nomeia o poço que a receita já recusa. Poço no disco não é o vazamento. Sem chave `poço`. Nomear não mede.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1085): **1146 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1085)
