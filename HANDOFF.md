...
**HEAD:** ver `git log -1` — vigente 0.9.510: o papel do x do campo nomeia o panner que a receita já recusa. Número no disco não é mix. Sem chave `panner`. Nomear não ouve.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.510): 571 / 516.
...
## O que o HEAD já entrega (0.9.91–0.9.510)
