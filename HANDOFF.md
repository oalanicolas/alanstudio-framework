...
**HEAD:** ver `git log -1` — vigente 0.9.772: o `save` nomeia a metade que a receita já recusa. Meio no disco não é o save. Sem chave `metade`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.772): **833 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.772)
