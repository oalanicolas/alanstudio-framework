...
**HEAD:** ver `git log -1` — vigente 0.9.907: o `feel` nomeia a intensidade que a receita já recusa. Intensidade no disco não é a referência. Sem chave `intensidade`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.907): **968 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.907)
