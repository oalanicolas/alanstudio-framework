...
**HEAD:** ver `git log -1` — vigente 0.9.773: o `record` nomeia o médio que a receita já recusa. Média no disco não é o problema. Sem chave `médio`. Nomear não mede.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.773): **834 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.773)
