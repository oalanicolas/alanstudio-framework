...
**HEAD:** ver `git log -1` — vigente 0.9.672: o `scale` nomeia o opcional que a receita já recusa. Escala no disco não é o piso. Sem chave `opcional`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.672): **733 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.672)
