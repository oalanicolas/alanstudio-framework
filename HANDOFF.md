...
**HEAD:** ver `git log -1` — vigente 0.9.1142: o observations do feel nomeia a anunciada que a receita já recusa. Anunciada no disco não é o feel. Sem chave `anunciada`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1142): **1203 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1142)
