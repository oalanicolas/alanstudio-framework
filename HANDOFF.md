...
**HEAD:** ver `git log -1` — vigente 0.9.864: o `content` nomeia os vivos que a receita já recusa. Vivos no disco não é a exportação. Sem chave `vivos`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.864): **925 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.864)
