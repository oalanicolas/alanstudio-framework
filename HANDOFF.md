...
**HEAD:** ver `git log -1` — vigente 0.9.843: o `feel` nomeia o descarte que a receita já recusa. Rumble no disco não é o descarte. Sem chave `descarte`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.843): **904 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.843)
