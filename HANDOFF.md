...
**HEAD:** ver `git log -1` — vigente 0.9.847: o item do craft nomeia a rede que a pesquisa já recusa. Estudo no disco não é a rede. Sem chave `rede`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.847): **908 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.847)
