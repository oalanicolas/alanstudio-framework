...
**HEAD:** ver `git log -1` — vigente 0.9.997: o `record` nomeia a vida que a receita já recusa. Vida no disco não é o vazamento. Sem chave `vida`. Nomear não mede.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.997): **1058 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.997)
