...
**HEAD:** ver `git log -1` — vigente 0.9.678: a área decisions nomeia a eficácia que o mapa já recusa. Mapa no disco não é o ensaio. Sem chave `eficácia`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.678): **739 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.678)
