...
**HEAD:** ver `git log -1` — vigente 0.9.1049: o item da observação nomeia o dilata que a receita já recusa. Dilata no disco não é o estado. Sem chave `dilata`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1049): **1110 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1049)
