...
**HEAD:** ver `git log -1` — vigente 0.9.644: o `unbudgeted` do `budget` nomeia o dispositivo que a receita já recusa. Manifesto no disco não é o quadro medido. Sem chave `dispositivo`. Listar não mede.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.644): **705 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.644)
