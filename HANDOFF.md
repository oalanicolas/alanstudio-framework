...
**HEAD:** ver `git log -1` — vigente 0.9.961: o item da observação nomeia a crítica que a receita já recusa. Crítica no disco não é o estado. Sem chave `crítica`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.961): **1022 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.961)
