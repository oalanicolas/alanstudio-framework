...
**HEAD:** ver `git log -1` — vigente 0.9.814: o `observations` do `feel` nomeia o ritmo que a receita já recusa. Juice no disco não é o ritmo. Sem chave `ritmo`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.814): **875 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.814)
