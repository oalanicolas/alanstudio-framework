...
**HEAD:** ver `git log -1` — vigente 0.9.609: o `qa_current` do `playtest` nomeia o assiste que a receita já recusa. Arquivo no disco não é a sessão. Sem chave `assiste`. Nomear não assiste.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.609): **670 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.609)
