...
**HEAD:** ver `git log -1` — vigente 0.9.969: o item da observação nomeia os comandos que a receita já recusa. Comandos no disco não é o estado. Sem chave `comandos`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.969): **1030 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.969)
