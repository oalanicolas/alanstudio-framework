...
**HEAD:** ver `git log -1` — vigente 0.9.987: o `feel` nomeia o utilitário que a receita já recusa. Utilitário no disco não é o feel. Sem chave `utilitário`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.987): **1048 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.987)
