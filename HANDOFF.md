...
**HEAD:** ver `git log -1` — vigente 0.9.824: o `content` nomeia o animador que a receita já recusa. Imagem no disco não é o animador. Sem chave `animador`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.824): **885 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.824)
