...
**HEAD:** ver `git log -1` — vigente 0.9.842: o ciclo nomeia a recuperação que a receita já recusa. Verbo no disco não é a recuperação. Sem chave `recuperação`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.842): **903 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.842)
