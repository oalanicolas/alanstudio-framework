...
**HEAD:** ver `git log -1` — vigente 0.9.614: o `versioned` do `save` nomeia a versão que a receita já recusa. Schema no disco não é a atualização. Sem chave `versão`. Nomear não migra.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.614): **675 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.614)
