...
**HEAD:** ver `git log -1` — vigente 0.9.620: o `unobserved` do `feel` nomeia o sentido que a receita já recusa. Arquivo no disco não é o verbo. Sem chave `sentido`. Nomear não sente.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.620): **681 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.620)
