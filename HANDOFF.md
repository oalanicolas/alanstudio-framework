...
**HEAD:** ver `git log -1` — vigente 0.9.633: o `contract_valid` do `check-plan` nomeia a obediência que o processo já recusa. Forma no disco não é o processo. Sem chave `obediência`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.633): **694 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.633)
