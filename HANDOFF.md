...
**HEAD:** ver `git log -1` — vigente 0.9.1011: o `feel` nomeia o consome que a receita já recusa. Consome no disco não é o feel. Sem chave `consome`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1011): **1072 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1011)
