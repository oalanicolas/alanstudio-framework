...
**HEAD:** ver `git log -1` — vigente 0.9.713: o `feel` nomeia a pose que a receita já recusa. Arquivo no disco não é o peso. Sem chave `pose`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.713): **774 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.713)
