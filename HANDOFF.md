...
**HEAD:** ver `git log -1` — vigente 0.9.838: o `observations` do `feel` nomeia as decisões que a receita já recusa. Alcance no disco não é as decisões. Sem chave `decisões`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.838): **899 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.838)
