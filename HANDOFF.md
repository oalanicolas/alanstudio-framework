...
**HEAD:** ver `git log -1` — vigente 0.9.527: o `categories[n]` do `sfx summary` nomeia a camada que a receita já recusa. Lista no disco não é mix. Sem chave `camada`. Nomear não ouve.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.527): 588 / 516.
...
## O que o HEAD já entrega (0.9.91–0.9.527)
...
`categories[n]` do `sfx summary`
nomeia a camada que a
receita já recusa. A receita já
dizia para usar só as camadas que
o jogo tem; o summary listava o
título e calava a recusa. Lista no
disco não é mix. Sem chave
`camada`. Nomear não ouve.
