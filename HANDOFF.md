...
**HEAD:** ver `git log -1` — vigente 0.9.637: o `empty` do `sfx summary` nomeia o acervo que a receita já recusa. Lista no disco não é mix. Sem chave `acervo`. Nomear não ouve.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.637): **698 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.637)
