...
**HEAD:** ver `git log -1` — vigente 0.9.753: o item da observação nomeia o polegar que a receita já recusa. Tecla no disco não é o polegar. Sem chave `polegar`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.753): **814 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.753)
