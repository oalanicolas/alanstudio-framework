...
**HEAD:** ver `git log -1` — vigente 0.9.1030: o observations do feel nomeia o tornam que a receita já recusa. Tornam no disco não é o feel. Sem chave `tornam`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1030): **1091 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1030)
