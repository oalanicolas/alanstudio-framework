...
**HEAD:** ver `git log -1` — vigente 0.9.939: o `feel` nomeia o copiado que a receita já recusa. Copiado no disco não é a instância. Sem chave `copiado`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.939): **1000 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.939)
