...
**HEAD:** ver `git log -1` — vigente 0.9.955: o `feel` nomeia o envelope que a receita já recusa. Envelope no disco não é o feel. Sem chave `envelope`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.955): **1016 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.955)
