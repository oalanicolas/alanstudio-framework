...
**HEAD:** ver `git log -1` — vigente 0.9.1033: o item da observação nomeia o sufixo que a receita já recusa. Sufixo no disco não é o estado. Sem chave `sufixo`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1033): **1094 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1033)
