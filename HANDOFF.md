...
**HEAD:** ver `git log -1` — vigente 0.9.665: o `context` nomeia o scanner que o roteiro já recusa. Sinal no disco não é o resultado. Sem chave `scanner`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.665): **726 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.665)
