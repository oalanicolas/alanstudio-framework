...
**HEAD:** ver `git log -1` — vigente 0.9.1119: o item do craft nomeia a teórica que a pesquisa já recusa. Teórica no disco não é a cadeia. Sem chave `teórica`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1119): **1180 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1119)
