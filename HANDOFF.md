...
**HEAD:** ver `git log -1` — vigente 0.9.1039: o item do craft nomeia o Descrito que a pesquisa já recusa. Descrito no disco não é a cadeia. Sem chave `Descrito`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1039): **1100 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1039)
