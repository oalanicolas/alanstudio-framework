...
**HEAD:** ver `git log -1` — vigente 0.9.799: o item do craft nomeia a contradição que a pesquisa já recusa. Fonte no disco não é a contradição. Sem chave `contradição`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.799): **860 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.799)
