...
**HEAD:** ver `git log -1` — vigente 0.9.812: o `save` nomeia o reconstruído que a receita já recusa. Início no disco não é o reconstruído. Sem chave `reconstruído`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.812): **873 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.812)
