...
**HEAD:** ver `git log -1` — vigente 0.9.882: o ciclo nomeia a trava que a receita já recusa. Trava no disco não é o buffer. Sem chave `trava`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.882): **943 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.882)
