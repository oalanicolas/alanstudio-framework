...
**HEAD:** ver `git log -1` — vigente 0.9.740: o `save` nomeia a observada que a receita já recusa. Save no disco não é a aba observada. Sem chave `observada`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.740): **801 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.740)
