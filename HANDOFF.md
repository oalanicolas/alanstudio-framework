...
**HEAD:** ver `git log -1` — vigente 0.9.877: o `record` nomeia o reflow que a receita já recusa. Reflow no disco não é o engasgo. Sem chave `reflow`. Nomear não mede.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.877): **938 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.877)
