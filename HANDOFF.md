...
**HEAD:** ver `git log -1` — vigente 0.9.765: o `record` nomeia o primeiro que a receita já recusa. Campo no disco não é a porta. Sem chave `primeiro`. Nomear não mede.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.765): **826 / 516**.
