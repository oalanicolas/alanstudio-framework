...
**HEAD:** ver `git log -1` — vigente 0.9.1113: o item da observação nomeia o relata que a receita já recusa. Relata no disco não é o estado. Sem chave `relata`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1113): **1174 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1113)
