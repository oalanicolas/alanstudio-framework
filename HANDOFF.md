...
**HEAD:** ver `git log -1` — vigente 0.9.1018: o ciclo nomeia o veículo que a receita já recusa. Veículo no disco não é o teste. Sem chave `veículo`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1018): **1079 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1018)
