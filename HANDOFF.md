...
**HEAD:** ver `git log -1` — vigente 0.9.1032: o content nomeia as alternativas que a receita já recusa. Alternativas no disco não é o destino. Sem chave `alternativas`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1032): **1093 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1032)
