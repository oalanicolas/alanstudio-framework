...
**HEAD:** ver `git log -1` — vigente 0.9.944: o `content` nomeia os pivôs que a receita já recusa. Pivôs no disco não é as dimensões. Sem chave `pivôs`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.944): **1005 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.944)
