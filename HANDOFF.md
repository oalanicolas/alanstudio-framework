...
**HEAD:** ver `git log -1` — vigente 0.9.816: o `content` nomeia a grade que a receita já recusa. Grade no disco não é o corte. Sem chave `grade`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.816): **877 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.816)
