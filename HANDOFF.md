...
**HEAD:** ver `git log -1` — vigente 0.9.826: o ciclo nomeia o membro que a receita já recusa. Frame no disco não é o membro. Sem chave `membro`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.826): **887 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.826)
