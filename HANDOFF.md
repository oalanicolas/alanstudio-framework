...
**HEAD:** ver `git log -1` — vigente 0.9.895: o item do craft nomeia os brutos que a pesquisa já recusa. Brutos no disco não é a cadeia. Sem chave `brutos`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.895): **956 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.895)
