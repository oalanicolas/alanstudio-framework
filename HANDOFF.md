...
**HEAD:** ver `git log -1` — vigente 0.9.856: o `content` nomeia as máquinas que a receita já recusa. Animação no disco não é as máquinas. Sem chave `máquinas`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.856): **917 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.856)
