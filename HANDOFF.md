...
**HEAD:** ver `git log -1` — vigente 0.9.1078: o observations nomeia o atacar que a receita já recusa. Atacar no disco não é o feel. Sem chave `atacar`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1078): **1139 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1078)
