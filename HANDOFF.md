...
**HEAD:** ver `git log -1` — vigente 0.9.519: a opção `game_speed` do `access` nomeia a precisão que a receita já recusa. Precisão no disco não é sessão. Sem chave `precisão`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.519): 580 / 516.
...
## O que o HEAD já entrega (0.9.91–0.9.519)
