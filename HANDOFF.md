...
**HEAD:** ver `git log -1` — vigente 0.9.676: o `budget` nomeia o estável que a receita já recusa. Média no disco não é o quadro. Sem chave `estável`. Nomear não mede.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.676): **737 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.676)
