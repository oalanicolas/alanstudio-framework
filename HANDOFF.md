...
**HEAD:** ver `git log -1` — vigente 0.9.1048: o content nomeia as Repetições que a receita já recusa. Repetições no disco não é o destino. Sem chave `Repetições`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1048): **1109 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1048)
