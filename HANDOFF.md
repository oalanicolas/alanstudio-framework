...
**HEAD:** ver `git log -1` — vigente 0.9.964: o `save` nomeia as entidades que a receita já recusa. Entidades no disco não é o save. Sem chave `entidades`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.964): **1025 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.964)
