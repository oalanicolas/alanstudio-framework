...
**HEAD:** ver `git log -1` — vigente 0.9.562: o `sources` do `save` nomeia a cadeia que a receita já recusa. Arquivo no disco não é a migração. Sem chave `cadeia`. Nomear não confia.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.562): **623 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.562)
