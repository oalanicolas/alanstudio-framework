...
**HEAD:** ver `git log -1` — vigente 0.9.1121: o item da observação nomeia o pinta que a receita já recusa. Pinta no disco não é o estado. Sem chave `pinta`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1121): **1182 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1121)
