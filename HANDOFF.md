...
**HEAD:** ver `git log -1` — vigente 0.9.1117: o `record` nomeia o objeto que a receita já recusa. Objeto no disco não é o vazamento. Sem chave `objeto`. Nomear não mede.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1117): **1178 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1117)
