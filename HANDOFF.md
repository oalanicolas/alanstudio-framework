...
**HEAD:** ver `git log -1` — vigente 0.9.1125: o record nomeia as cenas que a receita já recusa. Cenas no disco não é o vazamento. Sem chave `cenas`. Nomear não mede.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1125): **1186 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1125)
