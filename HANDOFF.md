...
**HEAD:** ver `git log -1` — vigente 0.9.1014: o `observations` do `feel` nomeia o verificam que a receita já recusa. Verificam no disco não é o feel. Sem chave `verificam`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1014): **1075 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1014)
