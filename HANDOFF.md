...
**HEAD:** ver `git log -1` — vigente 0.9.798: o `observations` do `feel` nomeia a silhueta que a receita já recusa. Pose no disco não é a silhueta. Sem chave `silhueta`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.798): **859 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.798)
