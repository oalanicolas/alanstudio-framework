...
**HEAD:** ver `git log -1` — vigente 0.9.1132: o save nomeia o Separe que a receita já recusa. Separe no disco não é o save. Sem chave `Separe`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1132): **1193 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1132)
