...
**HEAD:** ver `git log -1` — vigente 0.9.469: o `mda` do `scan` nomeia a pontuação que a guia já recusa. Área no disco não é experiência. Sem chave `pontuação`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes confirmadas no HEAD (0.9.469):** `python3 -m unittest discover -s tests` → 530 OK.
...
## O que o HEAD já entrega (0.9.91–0.9.469)
