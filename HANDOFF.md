...
**HEAD:** ver `git log -1` — vigente 0.9.778: o ciclo nomeia o seguinte que a receita já recusa. Foco no disco não é o verbo. Sem chave `seguinte`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.778): **839 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.778)
