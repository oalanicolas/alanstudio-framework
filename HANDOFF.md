...
**HEAD:** ver `git log -1` — vigente 0.9.521: a opção `live` do `access` nomeia o leitor que a receita já recusa. Overlay no disco não é sessão. Sem chave `leitor`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.521): 582 / 516.
...
## O que o HEAD já entrega (0.9.91–0.9.521)
