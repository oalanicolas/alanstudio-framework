...
**HEAD:** ver `git log -1` — vigente 0.9.735: o item da observação nomeia o ativo que a receita já recusa. Recibo no disco não é o modo. Sem chave `ativo`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.735): **796 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.735)
