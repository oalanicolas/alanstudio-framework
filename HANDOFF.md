...
**HEAD:** ver `git log -1` — vigente 0.9.1005: o `record` nomeia o consumo que a receita já recusa. Consumo no disco não é o vazamento. Sem chave `consumo`. Nomear não mede.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1005): **1066 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1005)
