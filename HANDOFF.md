...
**HEAD:** ver `git log -1` — vigente 0.9.696: o ciclo nomeia o lock que a receita já recusa. Lock no disco não é o descanso. Sem chave `lock`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.696): **757 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.696)
