...
**HEAD:** ver `git log -1` — vigente 0.9.517: a opção `one_hand` do `access` nomeia a mão que a receita já recusa. Mão no disco não é sessão. Sem chave `mão`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.517): 578 / 516.
...
## O que o HEAD já entrega (0.9.91–0.9.517)
