...
**HEAD:** ver `git log -1` — vigente 0.9.909: o `record` nomeia a cena que a receita já recusa. Cena no disco não é o engasgo. Sem chave `cena`. Nomear não mede.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.909): **970 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.909)
