...
**HEAD:** ver `git log -1` — vigente 0.9.1131: o feel nomeia os gestos que a receita já recusa. Gestos no disco não é o feel. Sem chave `gestos`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1131): **1192 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1131)
