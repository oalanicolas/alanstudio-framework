...
**HEAD:** ver `git log -1` — vigente 0.9.730: o ciclo nomeia o orbe que a receita já recusa. Toque no disco não é a escolha. Sem chave `orbe`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.730): **791 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.730)
