...
**HEAD:** ver `git log -1` — vigente 0.9.857: o item da observação nomeia o pressionar que a receita já recusa. Recibo no disco não é o pressionar. Sem chave `pressionar`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.857): **918 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.857)
