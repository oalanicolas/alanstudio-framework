...
**HEAD:** ver `git log -1` — vigente 0.9.601: o `constants` do `feel` nomeia o peso que o README já recusa. Número no disco não é o verbo. Sem chave `peso`. Nomear não sente.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.601): **662 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.601)
