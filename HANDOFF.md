...
**HEAD:** ver `git log -1` — vigente 0.9.1133: o record nomeia o comparável que a receita já recusa. Comparável no disco não é o vazamento. Sem chave `comparável`. Nomear não mede.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1133): **1194 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1133)
