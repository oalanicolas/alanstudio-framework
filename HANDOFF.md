...
**HEAD:** ver `git log -1` — vigente 0.9.887: o item do craft nomeia os pares que a pesquisa já recusa. Pares no disco não é os dados. Sem chave `pares`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.887): **948 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.887)
