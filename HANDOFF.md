...
**HEAD:** ver `git log -1` — vigente 0.9.1135: o item do craft nomeia o cuja que a pesquisa já recusa. Cuja no disco não é a cadeia. Sem chave `cuja`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1135): **1196 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1135)
