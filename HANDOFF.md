...
**HEAD:** ver `git log -1` — vigente 0.9.1081: o item da observação nomeia o cinza que a receita já recusa. Cinza no disco não é o estado. Sem chave `cinza`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1081): **1142 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1081)
