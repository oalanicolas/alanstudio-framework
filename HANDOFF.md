...
**HEAD:** ver `git log -1` — vigente 0.9.642: o `readable` do artifact do `ship` nomeia o legível que a receita já recusa. Manifesto no disco não é outra máquina. Sem chave `legível`. Ler não entrega.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.642): **703 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.642)
