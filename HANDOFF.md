...
**HEAD:** ver `git log -1` — vigente 0.9.1109: o record nomeia o escondia que a receita já recusa. Escondia no disco não é o vazamento. Sem chave `escondia`. Nomear não mede.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1109): **1170 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1109)
