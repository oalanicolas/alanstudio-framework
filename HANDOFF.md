...
**HEAD:** ver `git log -1` — vigente 0.9.1002: o ciclo nomeia o IK que a receita já recusa. IK no disco não é o teste. Sem chave `IK`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1002): **1063 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1002)
