...
**HEAD:** ver `git log -1` — vigente 0.9.834: o ciclo nomeia o startup que a receita já recusa. Verbo no disco não é o startup. Sem chave `startup`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.834): **895 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.834)
