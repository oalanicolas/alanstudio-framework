...
**HEAD:** ver `git log -1` — vigente 0.9.1136: o content nomeia o evita que a receita já recusa. Evita no disco não é o destino. Sem chave `evita`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1136): **1197 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1136)
