...
**HEAD:** ver `git log -1` — vigente 0.9.893: o `record` nomeia o shader que a receita já recusa. Shader no disco não é o engasgo. Sem chave `shader`. Nomear não mede.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.893): **954 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.893)
