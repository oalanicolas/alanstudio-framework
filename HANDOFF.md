...
**HEAD:** ver `git log -1` — vigente 0.9.1050: o ciclo nomeia a Resposta que a receita já recusa. Resposta no disco não é o teste. Sem chave `Resposta`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1050): **1111 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1050)
