...
**HEAD:** ver `git log -1` — vigente 0.9.973: o `record` nomeia os loops que a receita já recusa. Loops no disco não é o vazamento. Sem chave `loops`. Nomear não mede.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.973): **1034 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.973)
