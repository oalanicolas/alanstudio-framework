...
**HEAD:** ver `git log -1` — vigente 0.9.781: o `record` nomeia o registro que a receita já recusa. Falha no disco não é o registro. Sem chave `registro`. Nomear não mede.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.781): **842 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.781)
