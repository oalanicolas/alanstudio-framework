...
**HEAD:** ver `git log -1` — vigente 0.9.437: o `discover` nomeia a qualidade que o roteiro já recusa. Conta no disco não é acabamento. Sem chave `qualidade`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes confirmadas no HEAD (0.9.436):** `python3 -m unittest discover -s tests` → 432 OK.
`cd assets/starters/canvas-arcade && npm test` → 509 OK.
Confirmação pendente no 0.9.437.
...
## O que o HEAD já entrega (0.9.91–0.9.437)
