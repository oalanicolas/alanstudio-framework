...
**HEAD:** ver `git log -1` — vigente 0.9.948: o `save` nomeia os antigos que a receita já recusa. Antigos no disco não é o save. Sem chave `antigos`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.948): **1009 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.948)
