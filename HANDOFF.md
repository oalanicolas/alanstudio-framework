...
**HEAD:** ver `git log -1` — vigente 0.9.1070: o `observations` do `feel` nomeia o considerar que a receita já recusa. Considerar no disco não é o feel. Sem chave `considerar`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1070): **1131 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1070)
