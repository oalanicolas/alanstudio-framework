...
**HEAD:** ver `git log -1` — vigente 0.9.615: o `expected` do `budget` nomeia o suficiente que a receita já recusa. Pacote no disco não é o quadro. Sem chave `suficiente`. Nomear não mede.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.615): **676 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.615)
