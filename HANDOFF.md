...
**HEAD:** ver `git log -1` — vigente 0.9.744: o `content` nomeia os bancos que a receita já recusa. Refino no disco não é o banco. Sem chave `bancos`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.744): **805 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.744)
