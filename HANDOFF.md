...
**HEAD:** ver `git log -1` — vigente 0.9.1055: o item do craft nomeia as Janelas que a pesquisa já recusa. Janelas no disco não é a cadeia. Sem chave `Janelas`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1055): **1116 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1055)
