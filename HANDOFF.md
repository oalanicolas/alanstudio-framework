...
**HEAD:** ver `git log -1` — vigente 0.9.703: o `used` do `save` nomeia a aba que a receita já recusa. Número no disco não é a aba. Sem chave `aba`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.703): **764 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.703)
