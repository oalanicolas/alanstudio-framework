...
**HEAD:** ver `git log -1` — vigente 0.9.968: o `content` nomeia a projeção que a receita já recusa. Projeção no disco não é as dimensões. Sem chave `projeção`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.968): **1029 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.968)
