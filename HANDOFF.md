...
**HEAD:** ver `git log -1` — vigente 0.9.608: o `warned` do `save` nomeia a confiança que a receita já recusa. Arquivo no disco não é a aba. Sem chave `confiança`. Nomear não confia.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.608): **669 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.608)
