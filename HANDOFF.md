...
**HEAD:** ver `git log -1` — vigente 0.9.1076: o save nomeia o una que a receita já recusa. Una no disco não é o save. Sem chave `una`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1076): **1137 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1076)
