...
**Suítes confirmadas no HEAD anterior (0.9.378):** `python3 -m unittest discover -s tests` → 374 OK.
`cd assets/starters/canvas-arcade && npm test` → 509 OK. Confirmação do 0.9.379 pendente.
