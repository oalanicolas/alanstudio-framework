...
**HEAD:** ver `git log -1` — vigente 0.9.783: o item do craft nomeia o avatar que a pesquisa já recusa. Artigo no disco não é o avatar. Sem chave `avatar`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.783): **844 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.783)
