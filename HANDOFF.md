...
**HEAD:** ver `git log -1` — vigente 0.9.738: o ciclo nomeia a ordem que a receita já recusa. Ordem no disco não é a escolha. Sem chave `ordem`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.738): **799 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.738)
