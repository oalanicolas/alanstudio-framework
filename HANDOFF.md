...
**HEAD:** ver `git log -1` — vigente 0.9.827: o `feel` nomeia o corte que a receita já recusa. FPS no disco não é o corte. Sem chave `corte`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.827): **888 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.827)
