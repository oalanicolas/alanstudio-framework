...
**HEAD:** ver `git log -1` — vigente 0.9.878: o `observations` do `feel` nomeia o clipe que a receita já recusa. Clipe no disco não é o dono. Sem chave `clipe`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.878): **939 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.878)
