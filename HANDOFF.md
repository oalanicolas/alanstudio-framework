...
**HEAD:** ver `git log -1` — vigente 0.9.484: o `template` do MVP nomeia o valor que a guia já recusa. Molde no disco não é validação. Sem chave `valor`. Nomear não observa. Confirmação pendente.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmação pendente no 0.9.484 (anterior 0.9.483: 544 / 516).
...
## O que o HEAD já entrega (0.9.91–0.9.484)
