...
**HEAD:** ver `git log -1` — vigente 0.9.449: o `gate` nomeia o escopo que o roteiro já recusa. Linha no disco não é passagem. Sem chave `escopo`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**HEAD anterior + confirmação pendente:** suítes do 0.9.448 (444 / 509). Confirmação 0.9.449 depois das suítes.
...
## O que o HEAD já entrega (0.9.91–0.9.449)
...
`gate` nomeia o escopo que o
roteiro já recusa. O roteiro
já dizia que fora de escopo
não é dispensa; o problema
copiava o achado e calava a
recusa. Linha no disco não é
passagem. Sem chave `escopo`.
Nomear não observa. Anexar o
`scope` só em `gate_reading`,
não em `gate_declaration`.
