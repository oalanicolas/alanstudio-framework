...
**HEAD:** ver `git log -1` — vigente 0.9.963: o `feel` nomeia o acoplamento que a receita já recusa. Acoplamento no disco não é o feel. Sem chave `acoplamento`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.963): **1024 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.963)
