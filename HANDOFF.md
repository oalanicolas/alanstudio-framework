...
**HEAD:** ver `git log -1` — vigente 0.9.590: o `qa` do `playtest` nomeia a simulada que a receita já recusa. Arquivo no disco não é a sessão. Sem chave `simulada`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.590): **651 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.590)
