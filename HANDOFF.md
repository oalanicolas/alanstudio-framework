...
**HEAD:** ver `git log -1` — vigente 0.9.683: o next nomeia a validada que o next já recusa. Fonte no disco não é a tarefa. Sem chave `validada`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.683): **744 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.683)
