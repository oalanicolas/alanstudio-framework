...
**HEAD:** ver `git log -1` — vigente 0.9.606: o `catalog_exists` do `roles` nomeia o entra que a receita já recusa. Acervo no disco não é mix. Sem chave `entra`. Nomear não ouve.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.606): **667 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.606)
