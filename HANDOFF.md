...
**HEAD:** ver `git log -1` — vigente 0.9.766: o `observations` do `feel` nomeia o squash que a receita já recusa. Medida no disco não é o squash. Sem chave `squash`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.766): **827 / 516**.
