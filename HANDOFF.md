...
**HEAD:** ver `git log -1` — vigente 0.9.898: o ciclo nomeia o tilt que a receita já recusa. Tilt no disco não é a prioridade. Sem chave `tilt`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.898): **959 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.898)
