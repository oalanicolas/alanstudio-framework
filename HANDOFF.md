...
**HEAD:** ver `git log -1` — vigente 0.9.497: o `sfx info` do acervo nomeia o decode que a receita já recusa. Ficha no disco não é mix ouvida. Sem chave `decode`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.497): 558 / 516.
...
## O que o HEAD já entrega (0.9.91–0.9.497)
