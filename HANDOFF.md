...
**HEAD:** ver `git log -1` — vigente 0.9.880: o `content` nomeia a textura que a receita já recusa. Textura no disco não é as bordas. Sem chave `textura`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.880): **941 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.880)
