...
**HEAD:** ver `git log -1` — vigente 0.9.846: o `observations` do `feel` nomeia a autoria que a receita já recusa. Autoria no disco não é as decisões. Sem chave `autoria`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.846): **907 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.846)
