...
**HEAD:** ver `git log -1` — vigente 0.9.782: o `observations` do `feel` nomeia a tinta que a receita já recusa. Silhueta no disco não é a prática. Sem chave `tinta`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.782): **843 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.782)
