...
**HEAD:** ver `git log -1` — vigente 0.9.906: o ciclo nomeia o dash-attack que a receita já recusa. Dash-attack no disco não é a prioridade. Sem chave `dash-attack`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.906): **967 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.906)
