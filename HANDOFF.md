...
**HEAD:** ver `git log -1` — vigente 0.9.1134: o observations do feel nomeia o adaptar que a receita já recusa. Adaptar no disco não é o feel. Sem chave `adaptar`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1134): **1195 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1134)
