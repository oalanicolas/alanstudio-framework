...
**HEAD:** ver `git log -1` — vigente 0.9.1104: o content nomeia o alheio que a receita já recusa. Alheio no disco não é o destino. Sem chave `alheio`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1104): **1165 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1104)
