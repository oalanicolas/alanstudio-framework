...
**HEAD:** ver `git log -1` — vigente 0.9.998: o `observations` do `feel` nomeia a reação que a receita já recusa. Reação no disco não é o feel. Sem chave `reação`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.998): **1059 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.998)
