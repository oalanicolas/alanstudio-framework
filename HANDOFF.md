...
**HEAD:** ver `git log -1` — vigente 0.9.975: o item do craft nomeia o ideal que a pesquisa já recusa. Ideal no disco não é a cadeia. Sem chave `ideal`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.975): **1036 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.975)
