...
**HEAD:** ver `git log -1` — vigente 0.9.851: o `feel` nomeia o apagão que a receita já recusa. Quadros no disco não é o apagão. Sem chave `apagão`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.851): **912 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.851)
