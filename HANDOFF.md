...
**HEAD:** ver `git log -1` — vigente 0.9.787: o `feel` nomeia o gostoso que a receita já recusa. Feedback no disco não é a regra. Sem chave `gostoso`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.787): **848 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.787)
