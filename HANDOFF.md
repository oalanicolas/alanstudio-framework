...
**HEAD:** ver `git log -1` — vigente 0.9.1071: o item do craft nomeia os únicos que a pesquisa já recusa. Únicos no disco não é a cadeia. Sem chave `únicos`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1071): **1132 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1071)
