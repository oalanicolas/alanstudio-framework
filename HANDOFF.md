...
**HEAD:** ver `git log -1` — vigente 0.9.817: o item da observação nomeia a forma que a receita já recusa. PRD no disco não é a forma. Sem chave `forma`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.817): **878 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.817)
