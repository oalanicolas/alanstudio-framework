...
**HEAD:** ver `git log -1` — vigente 0.9.679: o warned do save nomeia a query que a receita já recusa. Endereço no disco não é a aba. Sem chave `query`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.679): **740 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.679)
