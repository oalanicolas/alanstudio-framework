...
**HEAD:** ver `git log -1` — vigente 0.9.1044: o save nomeia o corrompe que a receita já recusa. Corrompe no disco não é o save. Sem chave `corrompe`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1044): **1105 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1044)
