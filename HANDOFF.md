...
**HEAD:** ver `git log -1` — vigente 0.9.592: o `fields` do `origins` nomeia os três que o roteiro já recusa. Recibo no disco não é a concessão. Sem chave `três`. Nomear não concede.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.592): **653 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.592)
