...
**HEAD:** ver `git log -1` — vigente 0.9.525: o `gate` scale nomeia a repeatability que a receita já recusa. Linha no disco não é o próximo trecho. Sem chave `repeatability`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.525): 586 / 516.
...
## O que o HEAD já entrega (0.9.91–0.9.525)
...
`gate` scale
nomeia a repeatability que a
receita já recusa. A receita já
dizia que a slice sem repeatability
não está pronta para ampliar; o
item listava o readiness e calava
a recusa. Linha no disco não é o
próximo trecho. Sem chave
`repeatability`. Nomear não observa.
