...
**HEAD:** ver `git log -1` — vigente 0.9.757: o `record` nomeia o subpasso que a receita já recusa. Subpasso no disco não é o quadro. Sem chave `subpasso`. Nomear não mede.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.757): **818 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.757)
