...
**HEAD:** ver `git log -1` — vigente 0.9.994: o ciclo nomeia as transições que a receita já recusa. Transições no disco não é o teste. Sem chave `transições`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.994): **1055 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.994)
