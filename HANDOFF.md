...
**HEAD:** ver `git log -1` — vigente 0.9.832: o `content` nomeia a compatibilidade que a receita já recusa. Arquivo no disco não é a compatibilidade. Sem chave `compatibilidade`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.832): **893 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.832)
