...
**HEAD:** ver `git log -1` — vigente 0.9.854: o `observations` do `feel` nomeia as consequências que a receita já recusa. Consequências no disco não é as decisões. Sem chave `consequências`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.854): **915 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.854)
