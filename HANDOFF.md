...
**HEAD:** ver `git log -1` — vigente 0.9.1004: o `save` nomeia o divergem que a receita já recusa. Divergem no disco não é o save. Sem chave `divergem`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1004): **1065 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1004)
