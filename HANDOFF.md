...
**HEAD:** ver `git log -1` — vigente 0.9.986: o ciclo nomeia o deslocamento que a receita já recusa. Deslocamento no disco não é o teste. Sem chave `deslocamento`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.986): **1047 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.986)
