...
**HEAD:** ver `git log -1` — vigente 0.9.452: o `doctor` nomeia a ausência que o mapa já recusa. Lista no disco não é laboratório. Sem chave `ausência`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**HEAD anterior + confirmação pendente:** suítes do 0.9.451 (447 / 509). Confirmação 0.9.452 depois das suítes.
...
## O que o HEAD já entrega (0.9.91–0.9.452)
...
`doctor` nomeia a ausência que
o mapa já recusa. O mapa já
dizia que studies vazio não é
evidência negativa; o check
copiava o estado e calava a
recusa. Lista no disco não é
laboratório. Sem chave
`ausência`. Nomear não
observa.
