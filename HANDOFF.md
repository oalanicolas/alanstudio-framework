...
**HEAD:** ver `git log -1` — vigente 0.9.959: o item do craft nomeia a taxa que a pesquisa já recusa. Taxa no disco não é a cadeia. Sem chave `taxa`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.959): **1020 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.959)
