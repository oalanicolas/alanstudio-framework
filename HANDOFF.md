...
**HEAD:** ver `git log -1` — vigente 0.9.579: o `candidate_spawn` nomeia a retoma que a receita já recusa. Mesa no disco não é a sessão. Sem chave `retoma`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.579): **640 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.579)
