...
**HEAD:** ver `git log -1` — vigente 0.9.884: o `save` nomeia a bateria que a receita já recusa. Bateria no disco não é a interrupção. Sem chave `bateria`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.884): **945 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.884)
