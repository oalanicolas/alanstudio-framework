...
**HEAD:** ver `git log -1` — vigente 0.9.692: o constants do feel nomeia a janela que a receita já recusa. Coil no disco não é a janela. Sem chave `janela`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.692): **753 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.692)
