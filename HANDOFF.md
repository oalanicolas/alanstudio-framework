...
**HEAD:** ver `git log -1` — vigente 0.9.848: o `content` nomeia a retomada que a receita já recusa. Pose no disco não é a retomada. Sem chave `retomada`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.848): **909 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.848)
