...
**HEAD:** ver `git log -1` — vigente 0.9.724: o `record` nomeia o alvo que a receita já recusa. Editor no disco não é o build. Sem chave `alvo`. Nomear não mede.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.724): **785 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.724)
