...
**HEAD:** ver `git log -1` — vigente 0.9.704: o `record` nomeia o solver que a receita já recusa. Ganho rejeitado no disco não é o solver. Sem chave `solver`. Nomear não mede.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.704): **765 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.704)
