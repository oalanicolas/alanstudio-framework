...
**HEAD:** ver `git log -1` — vigente 0.9.693: o used do save nomeia a audição que a receita já recusa. Ouvir no disco não é a aba. Sem chave `audição`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.693): **754 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.693)
