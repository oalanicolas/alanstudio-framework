...
**HEAD:** ver `git log -1` — vigente 0.9.940: o `save` nomeia a reordenação que a receita já recusa. Reordenação no disco não é o save. Sem chave `reordenação`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.940): **1001 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.940)
