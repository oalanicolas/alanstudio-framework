...
**HEAD:** ver `git log -1` — vigente 0.9.655: a área `architecture` do `scan` nomeia a estimativa que a receita já recusa. Receita no disco não é decisão. Sem chave `estimativa`. Nomear não escolhe.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.655): **716 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.655)
