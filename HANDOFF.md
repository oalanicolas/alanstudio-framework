...
**HEAD:** ver `git log -1` — vigente 0.9.801: o item da observação nomeia a escolha que a receita já recusa. GDD no disco não é a escolha. Sem chave `escolha`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.801): **862 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.801)
