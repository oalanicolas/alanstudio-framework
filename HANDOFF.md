...
**HEAD:** ver `git log -1` — vigente 0.9.763: o `feel` nomeia o come que a receita já recusa. Relógio no disco não é a guarda. Sem chave `come`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.763): **824 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.763)
