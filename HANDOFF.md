...
**HEAD:** ver `git log -1` — vigente 0.9.960: o `content` nomeia os bounds que a receita já recusa. Bounds no disco não é as dimensões. Sem chave `bounds`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.960): **1021 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.960)
