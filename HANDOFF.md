...
**HEAD:** ver `git log -1` — vigente 0.9.1075: o feel nomeia o easing que a receita já recusa. Easing no disco não é o feel. Sem chave `easing`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1075): **1136 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1075)
