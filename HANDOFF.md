...
**HEAD:** ver `git log -1` — vigente 0.9.397: o `gate` nomeia o gate que a tabela já declara. Linha no disco não é passagem concedida. Sem chave `gate`. Nomear não concede.
