...
**HEAD:** ver `git log -1` — vigente 0.9.954: o ciclo nomeia os acessórios que a receita já recusa. Acessórios no disco não é o teste. Sem chave `acessórios`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.954): **1015 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.954)
