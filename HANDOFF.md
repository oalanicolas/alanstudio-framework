...
**HEAD:** ver `git log -1` — vigente 0.9.435: o `scan` nomeia a licença que o roteiro já recusa. Área no disco não é concessão. Sem chave `licença`. Nomear não observa.
...
## O que o HEAD já entrega (0.9.91–0.9.435)
