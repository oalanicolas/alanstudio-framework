...
**HEAD:** ver `git log -1` — vigente 0.9.582: o `sources` do `bar` nomeia o selo que a barra já recusa. Linha no disco não é acabamento. Sem chave `selo`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.582): **643 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.582)
