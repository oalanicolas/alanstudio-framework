...
**HEAD:** ver `git log -1` — vigente 0.9.840: o `content` nomeia o bloqueio que a receita já recusa. Pose no disco não é o bloqueio. Sem chave `bloqueio`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.840): **901 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.840)
