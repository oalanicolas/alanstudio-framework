...
**HEAD:** ver `git log -1` — vigente 0.9.1100: o save nomeia o irreversível que a receita já recusa. Irreversível no disco não é o save. Sem chave `irreversível`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1100): **1161 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1100)
