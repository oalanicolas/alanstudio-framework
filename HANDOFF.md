...
**HEAD:** ver `git log -1` — vigente 0.9.770: o ciclo nomeia o segue que a receita já recusa. Aba no disco não é o corpo. Sem chave `segue`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.770): **831 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.765)
