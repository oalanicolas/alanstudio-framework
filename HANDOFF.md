...
**HEAD:** ver `git log -1` — vigente 0.9.1009: o item da observação nomeia os flashes que a receita já recusa. Flashes no disco não é o estado. Sem chave `flashes`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1009): **1070 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1009)
