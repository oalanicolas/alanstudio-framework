...
**HEAD:** ver `git log -1` — vigente 0.9.980: o `save` nomeia os níveis que a receita já recusa. Níveis no disco não é o save. Sem chave `níveis`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.980): **1041 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.980)
