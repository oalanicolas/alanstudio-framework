...
**HEAD:** ver `git log -1` — vigente 0.9.830: o `observations` do `feel` nomeia a previsão que a receita já recusa. Recibo no disco não é a previsão. Sem chave `previsão`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.830): **891 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.830)
