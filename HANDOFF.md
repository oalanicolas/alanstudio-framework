...
**HEAD:** ver `git log -1` — vigente 0.9.682: o studio_assets nomeia o tocar que o mapa já recusa. Página no disco não é o mix. Sem chave `tocar`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.682): **743 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.682)
