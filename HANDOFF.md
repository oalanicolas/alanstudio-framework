...
**HEAD:** ver `git log -1` — vigente 0.9.1017: o item da observação nomeia a agressiva que a receita já recusa. Agressiva no disco não é o estado. Sem chave `agressiva`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1017): **1078 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1017)
