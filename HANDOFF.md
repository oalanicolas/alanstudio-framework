...
**HEAD:** ver `git log -1` — vigente 0.9.581: o `bible` do `art` nomeia o rascunho que a receita já recusa. Arquivo no disco não é comparação. Sem chave `rascunho`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.581): **642 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.581)
