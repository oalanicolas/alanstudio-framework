...
**HEAD:** ver `git log -1` — vigente 0.9.996: o `save` nomeia o recalculado que a receita já recusa. Recalculado no disco não é o save. Sem chave `recalculado`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.996): **1057 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.996)
