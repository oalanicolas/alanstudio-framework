...
**HEAD:** ver `git log -1` — vigente 0.9.918: o `observations` do `feel` nomeia a entrada que a receita já recusa. Entrada no disco não é a janela. Sem chave `entrada`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.918): **979 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.918)
