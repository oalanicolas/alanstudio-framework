...
**HEAD:** ver `git log -1` — vigente 0.9.771: o `feel` nomeia o mortal que a receita já recusa. Coleta no disco não é o golpe. Sem chave `mortal`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.771): **832 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.771)
