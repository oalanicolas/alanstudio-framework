...
**HEAD:** ver `git log -1` — vigente 0.9.1053: o record nomeia o compacta que a receita já recusa. Compacta no disco não é o vazamento. Sem chave `compacta`. Nomear não mede.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1053): **1114 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1053)
