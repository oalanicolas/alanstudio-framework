...
**HEAD:** ver `git log -1` — vigente 0.9.691: o craft nomeia o pular que o craft já recusa. Confirmação no disco não é o ofício. Sem chave `pular`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.691): **752 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.691)
