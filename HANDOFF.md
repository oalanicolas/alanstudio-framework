...
**HEAD:** ver `git log -1` — vigente 0.9.958: o `observations` do `feel` nomeia a antecipação que a receita já recusa. Antecipação no disco não é a previsão. Sem chave `antecipação`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.958): **1019 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.958)
