...
**HEAD:** ver `git log -1` — vigente 0.9.800: o `content` nomeia as ferragens que a receita já recusa. Módulo no disco não é a ferragem. Sem chave `ferragens`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.800): **861 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.800)
