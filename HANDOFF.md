...
**HEAD:** ver `git log -1` — vigente 0.9.789: o `record` nomeia a fixture que a receita já recusa. Fixture no disco não é o efeito. Sem chave `fixture`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.789): **850 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.789)
