...
**HEAD:** ver `git log -1` — vigente 0.9.981: o `record` nomeia as conexões que a receita já recusa. Conexões no disco não é o vazamento. Sem chave `conexões`. Nomear não mede.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.981): **1042 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.981)
