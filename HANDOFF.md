...
**HEAD:** ver `git log -1` — vigente 0.9.694: o unobserved do feel nomeia a guarda que a receita já recusa. Guarda no disco não é a janela. Sem chave `guarda`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.694): **755 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.694)
