...
**HEAD:** ver `git log -1` — vigente 0.9.1026: o ciclo nomeia o cursor que a receita já recusa. Cursor no disco não é o teste. Sem chave `cursor`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1026): **1087 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1026)
