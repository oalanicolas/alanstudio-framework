...
**HEAD:** ver `git log -1` — vigente 0.9.695: o feel nomeia o engolido que a receita já recusa. Hitstop no disco não é o perdão. Sem chave `engolido`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.695): **756 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.695)
