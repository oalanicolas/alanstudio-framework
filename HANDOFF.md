...
**HEAD:** ver `git log -1` — vigente 0.9.821: o `record` nomeia o mapa que a receita já recusa. Cópia no disco não é o visível. Sem chave `mapa`. Nomear não mede.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.821): **882 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.821)
