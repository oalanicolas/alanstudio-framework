...
**HEAD:** ver `git log -1` — vigente 0.9.991: o item do craft nomeia o replicável que a pesquisa já recusa. Replicável no disco não é a cadeia. Sem chave `replicável`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.991): **1052 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.991)
