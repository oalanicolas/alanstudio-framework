...
**HEAD:** ver `git log -1` — vigente 0.9.932: o `save` nomeia os momentos que a receita já recusa. Momentos no disco não é a interrupção. Sem chave `momentos`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.932): **993 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.932)
