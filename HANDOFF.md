...
## O que o HEAD já entrega (0.9.91–0.9.462)
...
`candidate_curve`
nomeia o aperto que a
receita já recusa. A receita já
dizia que aperto no disco não é
curva observada; a curva copiava
never_banked e calava a recusa.
Número no disco não é sessão. Sem
chave `aperto`. Nomear não observa.
