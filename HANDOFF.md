...
**HEAD:** ver `git log -1` — vigente 0.9.761: o item da observação nomeia o avanço que a receita já recusa. Tap no disco não é o avanço. Sem chave `avanço`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.761): **822 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.761)
