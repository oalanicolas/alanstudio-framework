...
**HEAD:** ver `git log -1` — vigente 0.9.1066: o ciclo nomeia o passar que a receita já recusa. Passar no disco não é o teste. Sem chave `passar`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1066): **1127 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1066)
