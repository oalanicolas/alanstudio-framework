...
**HEAD:** ver `git log -1` — vigente 0.9.1137: o item da observação nomeia o terminado que a receita já recusa. Terminado no disco não é o estado. Sem chave `terminado`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1137): **1198 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1137)
