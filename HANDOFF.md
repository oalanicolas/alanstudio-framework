...
**HEAD:** ver `git log -1` — vigente 0.9.861: o `record` nomeia as consultas que a receita já recusa. Taxa no disco não é as consultas. Sem chave `consultas`. Nomear não mede.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.861): **922 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.861)
