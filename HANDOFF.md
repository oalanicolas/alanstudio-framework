...
**HEAD:** ver `git log -1` — vigente 0.9.1083: o feel nomeia o impulse que a receita já recusa. Impulse no disco não é o feel. Sem chave `impulse`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1083): **1144 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1083)
