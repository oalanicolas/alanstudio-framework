...
**HEAD:** ver `git log -1` — vigente 0.9.979: o `feel` nomeia o juice que a receita já recusa. Juice no disco não é o feel. Sem chave `juice`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.979): **1040 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.979)
