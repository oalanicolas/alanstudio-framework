...
**HEAD:** ver `git log -1` — vigente 0.9.511: o `roles` nomeia o retomar que a receita já recusa. Pedido no disco não é mix. Sem chave `retomar`. Nomear não ouve.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.511): 572 / 516.
...
## O que o HEAD já entrega (0.9.91–0.9.511)
