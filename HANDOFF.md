...
**HEAD:** ver `git log -1` — vigente 0.9.623: o `required` do `audit` nomeia o começo que o roteiro já recusa. JSON no disco não é o levantamento. Sem chave `começo`. Nomear não começa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.623): **684 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.623)
