...
**HEAD:** ver `git log -1` — vigente 0.9.982: o `observations` do `feel` nomeia os saltos que a receita já recusa. Saltos no disco não é o feel. Sem chave `saltos`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.982): **1043 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.982)
