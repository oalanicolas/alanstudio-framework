...
**HEAD:** ver `git log -1` — vigente 0.9.947: o `feel` nomeia a instância que a receita já recusa. Instância no disco não é o feel. Sem chave `instância`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.947): **1008 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.947)
