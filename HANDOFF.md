...
**HEAD:** ver `git log -1` — vigente 0.9.1101: o record nomeia o telegraph que a receita já recusa. Telegraph no disco não é o vazamento. Sem chave `telegraph`. Nomear não mede.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1101): **1162 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1101)
