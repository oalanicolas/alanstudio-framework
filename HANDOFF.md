...
**HEAD:** ver `git log -1` — vigente 0.9.862: o `observations` do `feel` nomeia o visual que a receita já recusa. Visual no disco não é o feel. Sem chave `visual`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.862): **923 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.862)
