...
**HEAD:** ver `git log -1` — vigente 0.9.1122: o ciclo nomeia o mudar que a receita já recusa. Mudar no disco não é o teste. Sem chave `mudar`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1122): **1183 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1122)
