...
**HEAD:** ver `git log -1` — vigente 0.9.1103: o item do craft nomeia o conferível que a pesquisa já recusa. Conferível no disco não é a cadeia. Sem chave `conferível`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1103): **1164 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1103)
