...
**HEAD:** ver `git log -1` — vigente 0.9.1042: o ciclo nomeia o bastante que a receita já recusa. Bastante no disco não é o teste. Sem chave `bastante`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1042): **1103 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1042)
