...
**HEAD:** ver `git log -1` — vigente 0.9.548: o `fields` do `record --kind budget` nomeia a quente que a receita já recusa. Plataforma no disco não é a máquina fria. Sem chave `quente`. Nomear não mede.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.548): **609 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.548)
