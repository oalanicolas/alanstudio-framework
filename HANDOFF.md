...
**HEAD:** ver `git log -1` — vigente 0.9.1040: o content nomeia a projetada que a receita já recusa. Projetada no disco não é o destino. Sem chave `projetada`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1040): **1101 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1040)
