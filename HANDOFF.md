...
**HEAD:** ver `git log -1` — vigente 0.9.1073: o item da observação nomeia a graça que a receita já recusa. Graça no disco não é o estado. Sem chave `graça`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1073): **1134 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1073)
