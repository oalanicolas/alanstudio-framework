...
**HEAD:** ver `git log -1` — vigente 0.9.970: o ciclo nomeia as plataformas que a receita já recusa. Plataformas no disco não é o teste. Sem chave `plataformas`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.970): **1031 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.970)
