...
**HEAD:** ver `git log -1` — vigente 0.9.934: o `observations` do `feel` nomeia o salto que a receita já recusa. Salto no disco não é o relógio. Sem chave `salto`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.934): **995 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.934)
