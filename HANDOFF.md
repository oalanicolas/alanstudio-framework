...
**HEAD:** ver `git log -1` — vigente 0.9.1031: o item do craft nomeia o 240 que a pesquisa já recusa. 240 no disco não é a cadeia. Sem chave `240`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1031): **1092 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1031)
