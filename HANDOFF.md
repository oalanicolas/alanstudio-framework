...
**HEAD:** ver `git log -1` — vigente 0.9.839: o item do craft nomeia o desempenho que a pesquisa já recusa. Diferença no disco não é o desempenho. Sem chave `desempenho`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.839): **900 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.839)
