...
**HEAD:** ver `git log -1` — vigente 0.9.936: o `content` nomeia a física que a receita já recusa. Física no disco não é as dimensões. Sem chave `física`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.936): **997 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.936)
