...
**HEAD:** ver `git log -1` — vigente 0.9.825: o item da observação nomeia as barreiras que a receita já recusa. Lista no disco não é a barreira. Sem chave `barreiras`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.825): **886 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.825)
