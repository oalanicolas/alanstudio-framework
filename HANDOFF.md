...
**HEAD:** ver `git log -1` — vigente 0.9.706: o `content` nomeia o material que a receita já recusa. Material no disco não é a forma. Sem chave `material`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.706): **767 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.706)
