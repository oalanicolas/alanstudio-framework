...
**HEAD:** ver `git log -1` — vigente 0.9.721: o `skipped` do `pin` nomeia o marcador que o README já recusa. Skill no disco não é o atalho. Sem chave `marcador`. Nomear não remove.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.721): **782 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.721)
