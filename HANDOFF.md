...
**HEAD:** ver `git log -1` — vigente 0.9.700: o `art` nomeia o punch que a receita já recusa. Lean no disco não é o punch. Sem chave `punch`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.700): **761 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.700)
