...
**HEAD:** ver `git log -1` — vigente 0.9.400: o `template` nomeia a publicação que o molde já recusa. Molde no disco não é autorização. Sem chave `publicar`. Nomear não concede.
