...
**HEAD:** ver `git log -1` — vigente 0.9.924: o `save` nomeia a atômica que a receita já recusa. Atômica no disco não é a substituição. Sem chave `atômica`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.924): **985 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.924)
