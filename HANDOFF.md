...
**HEAD:** ver `git log -1` — vigente 0.9.917: o `record` nomeia o carregamento que a receita já recusa. Carregamento no disco não é o engasgo. Sem chave `carregamento`. Nomear não mede.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.917): **978 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.917)
