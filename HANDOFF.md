...
**HEAD:** ver `git log -1` — vigente 0.9.1140: o save nomeia a coisa que a receita já recusa. Coisa no disco não é o save. Sem chave `coisa`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1140): **1201 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1140)
