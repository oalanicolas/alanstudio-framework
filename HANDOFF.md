...
**HEAD:** ver `git log -1` — vigente 0.9.972: o `save` nomeia a conveniência que a receita já recusa. Conveniência no disco não é o save. Sem chave `conveniência`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.972): **1033 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.972)
