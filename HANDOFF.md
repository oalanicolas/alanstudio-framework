...
**HEAD:** ver `git log -1` — vigente 0.9.747: o `feel` nomeia o inflama que a receita já recusa. Sit no disco não é a aposta. Sem chave `inflama`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.747): **808 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.747)
