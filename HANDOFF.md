...
**HEAD:** ver `git log -1` — vigente 0.9.656: o `production_bar` nomeia a equipe que a receita já recusa. Receita no disco não é acabamento. Sem chave `equipe`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.656): **717 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.656)
