...
**HEAD:** ver `git log -1` — vigente 0.9.1003: o `feel` nomeia o canônico que a receita já recusa. Canônico no disco não é o feel. Sem chave `canônico`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1003): **1064 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1003)
