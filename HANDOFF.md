...
**HEAD:** ver `git log -1` — vigente 0.9.942: o `observations` do `feel` nomeia o giro que a receita já recusa. Giro no disco não é os saltos. Sem chave `giro`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.942): **1003 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.942)
