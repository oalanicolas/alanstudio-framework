...
**HEAD:** ver `git log -1` — vigente 0.9.551: o `art` nomeia a geometria que a receita já recusa. Número no disco não é a silhueta. Sem chave `geometria`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.551): **612 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.551)
