...
**HEAD:** ver `git log -1` — vigente 0.9.985: o item da observação nomeia o design que a receita já recusa. Design no disco não é o estado. Sem chave `design`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.985): **1046 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.985)
