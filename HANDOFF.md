...
**HEAD:** ver `git log -1` — vigente 0.9.1074: o ciclo nomeia o ambos que a receita já recusa. Ambos no disco não é o teste. Sem chave `ambos`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1074): **1135 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1074)
