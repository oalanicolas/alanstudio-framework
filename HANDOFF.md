...
**HEAD:** ver `git log -1` — vigente 0.9.1063: o item do craft nomeia os auditáveis que a pesquisa já recusa. Auditáveis no disco não é a cadeia. Sem chave `auditáveis`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1063): **1124 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1063)
