...
**HEAD:** ver `git log -1` — vigente 0.9.1013: o `record` nomeia as texturas que a receita já recusa. Texturas no disco não é o vazamento. Sem chave `texturas`. Nomear não mede.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1013): **1074 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1013)
