...
**HEAD:** ver `git log -1` — vigente 0.9.871: o item do craft nomeia o blog que a pesquisa já recusa. Blog no disco não é o método. Sem chave `blog`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.871): **932 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.871)
