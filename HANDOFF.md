...
**HEAD:** ver `git log -1` — vigente 0.9.1095: o item do craft nomeia a construção que a pesquisa já recusa. Construção no disco não é a cadeia. Sem chave `construção`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1095): **1156 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1095)
