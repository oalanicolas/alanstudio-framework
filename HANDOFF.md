...
**HEAD:** ver `git log -1` — vigente 0.9.1124: o save nomeia o destruir que a receita já recusa. Destruir no disco não é o save. Sem chave `destruir`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1124): **1185 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1124)
