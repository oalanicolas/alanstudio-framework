...
**HEAD:** ver `git log -1` — vigente 0.9.1056: o content nomeia o preservam que a receita já recusa. Preservam no disco não é o destino. Sem chave `preservam`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1056): **1117 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1056)
