...
**HEAD:** ver `git log -1` — vigente 0.9.795: o `feel` nomeia o quebrado que a receita já recusa. Hitstop no disco não é o tempo. Sem chave `quebrado`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.795): **856 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.795)
