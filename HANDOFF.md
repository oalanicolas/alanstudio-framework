...
**HEAD:** ver `git log -1` — vigente 0.9.508: o `missing` do `sfx verify` nomeia o 404 que a receita já recusa. Lista no disco não é mix. Sem chave `404`. Nomear não ouve.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.508): 569 / 516.
...
## O que o HEAD já entrega (0.9.91–0.9.508)
