...
**HEAD:** ver `git log -1` — vigente 0.9.885: o `record` nomeia o lixo que a receita já recusa. Lixo no disco não é o engasgo. Sem chave `lixo`. Nomear não mede.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.885): **946 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.885)
