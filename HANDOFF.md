...
**HEAD:** ver `git log -1` — vigente 0.9.822: o `observations` do `feel` nomeia o elo que a receita já recusa. Partícula no disco não é o elo. Sem chave `elo`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.822): **883 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.822)
