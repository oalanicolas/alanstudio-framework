...
**HEAD:** ver `git log -1` — vigente 0.9.479: o `continuity.prompt` nomeia a receita que o gauntlet já recusa. Prompt no disco não é o estado. Sem chave `receita`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** HEAD anterior (0.9.478: 539 / 516) + confirmação pendente.
...
## O que o HEAD já entrega (0.9.91–0.9.479)
