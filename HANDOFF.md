...
**HEAD:** ver `git log -1` — vigente 0.9.1093: o record nomeia o reusa que a receita já recusa. Reusa no disco não é o vazamento. Sem chave `reusa`. Nomear não mede.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1093): **1154 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1093)
