...
## O que o HEAD já entrega (0.9.91–0.9.377)
...
`playtest` nomeia o recado
que o serve já grava. A
página já pedia o POST; o
comando dizia que a página
escreve e calava a rota.
Texto no disco não é alguém
de fora. Sem chave `note`.
Não promove `outsider`. Sem
`then`.
