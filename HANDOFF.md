...
**HEAD:** ver `git log -1` — vigente 0.9.1139: o feel nomeia os específicos que a receita já recusa. Específicos no disco não é o feel. Sem chave `específicos`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1139): **1200 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1139)
