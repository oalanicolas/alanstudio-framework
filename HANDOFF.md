...
**HEAD:** ver `git log -1` — vigente 0.9.971: o `feel` nomeia a curva que a receita já recusa. Curva no disco não é o feel. Sem chave `curva`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.971): **1032 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.971)
