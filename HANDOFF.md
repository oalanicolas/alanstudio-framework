...
**HEAD:** ver `git log -1` — vigente 0.9.522: o convite nomeia as sessões que a receita já recusa. Convite no disco não é alguém de fora. Sem chave `sessões`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.522): 583 / 516.
...
## O que o HEAD já entrega (0.9.91–0.9.522)
