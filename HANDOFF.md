...
**HEAD:** ver `git log -1` — vigente 0.9.612: o `empty` do `doctor` nomeia a pasta que a receita já recusa. Lista no disco não é projeto criado. Sem chave `pasta`. Nomear não cria.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.612): **673 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.612)
