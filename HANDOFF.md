...
**HEAD:** ver `git log -1` — vigente 0.9.1068: o `save` nomeia os distintos que a receita já recusa. Distintos no disco não é o save. Sem chave `distintos`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1068): **1129 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1068)
