...
**HEAD:** ver `git log -1` — vigente 0.9.1128: o content nomeia os objetos que a receita já recusa. Objetos no disco não é o destino. Sem chave `objetos`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1128): **1189 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1128)
