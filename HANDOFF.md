...
**HEAD:** ver `git log -1` — vigente 0.9.833: o item da observação nomeia a zona que a receita já recusa. Recibo no disco não é a zona. Sem chave `zona`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.833): **894 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.833)
