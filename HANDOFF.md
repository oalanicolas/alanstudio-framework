...
**HEAD:** ver `git log -1` — vigente 0.9.1087: o item do craft nomeia a natureza que a pesquisa já recusa. Natureza no disco não é a cadeia. Sem chave `natureza`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1087): **1148 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1087)
