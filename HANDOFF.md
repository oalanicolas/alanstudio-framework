...
**HEAD:** ver `git log -1` — vigente 0.9.793: o item da observação nomeia o retrabalho que a receita já recusa. Conteúdo no disco não é o acesso. Sem chave `retrabalho`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.793): **854 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.793)
