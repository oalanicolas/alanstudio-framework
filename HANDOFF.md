...
**HEAD:** ver `git log -1` — vigente 0.9.446: o `gate` nomeia a dispensa que o roteiro já recusa. Linha no disco não é passagem. Sem chave `dispensa`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes confirmadas no HEAD (0.9.446):** `python3 -m unittest discover -s tests` → 442 OK.
...
## O que o HEAD já entrega (0.9.91–0.9.446)
