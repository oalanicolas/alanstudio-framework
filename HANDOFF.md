...
**HEAD:** ver `git log -1` — vigente 0.9.1091: o feel nomeia o clique que a receita já recusa. Clique no disco não é o feel. Sem chave `clique`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1091): **1152 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1091)
