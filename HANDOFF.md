...
**HEAD:** ver `git log -1` — vigente 0.9.899: o `feel` nomeia o estilo que a receita já recusa. Estilo no disco não é a referência. Sem chave `estilo`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.899): **960 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.899)
