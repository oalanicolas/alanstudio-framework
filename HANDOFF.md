...
**HEAD:** ver `git log -1` — vigente 0.9.648: o `empty` do `sfx search` nomeia a busca que a receita já recusa. Lista no disco não é mix. Sem chave `busca`. Nomear não ouve.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.648): **709 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.648)
