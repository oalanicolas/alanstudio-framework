...
**HEAD:** ver `git log -1` — vigente 0.9.1064: o content nomeia as disjuntas que a receita já recusa. Disjuntas no disco não é o destino. Sem chave `disjuntas`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1064): **1125 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1064)
