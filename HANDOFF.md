...
**HEAD:** ver `git log -1` — vigente 0.9.993: o item da observação nomeia a paralaxe que a receita já recusa. Paralaxe no disco não é o estado. Sem chave `paralaxe`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.993): **1054 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.993)
