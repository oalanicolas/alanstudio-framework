...
**HEAD:** ver `git log -1` — vigente 0.9.686: a área mda nomeia o obrigatório que a guia já recusa. Ferramenta no disco não é a obrigação. Sem chave `obrigatório`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.686): **747 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.686)
