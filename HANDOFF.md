...
**HEAD:** ver `git log -1` — vigente 0.9.920: o `content` nomeia a iluminação que a receita já recusa. Iluminação no disco não é as emendas. Sem chave `iluminação`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.920): **981 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.920)
