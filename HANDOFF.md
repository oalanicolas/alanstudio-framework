...
**HEAD:** ver `git log -1` — vigente 0.9.752: o `content` nomeia a omitida que a receita já recusa. Omissão no disco não é a falha. Sem chave `omitida`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.752): **813 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.752)
