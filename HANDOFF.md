...
**HEAD:** ver `git log -1` — vigente 0.9.726: o `budget` nomeia o perfil que a receita já recusa. Perfil no disco não é a medição. Sem chave `perfil`. Nomear não mede.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.726): **787 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.726)
