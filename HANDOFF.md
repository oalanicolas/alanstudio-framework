...
**HEAD:** ver `git log -1` — vigente 0.9.1060: o save nomeia o qualquer que a receita já recusa. Qualquer no disco não é o save. Sem chave `qualquer`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1060): **1121 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1060)
