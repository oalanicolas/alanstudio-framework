...
**HEAD:** ver `git log -1` — vigente 0.9.938: o ciclo nomeia o sólido que a receita já recusa. Sólido no disco não é o teste. Sem chave `sólido`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.938): **999 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.938)
