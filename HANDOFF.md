...
**HEAD:** ver `git log -1` — vigente 0.9.512: a opção `haptics` do `access` nomeia o controle que a receita já recusa. Pulso no disco não é sessão. Sem chave `controle`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.512): 573 / 516.
...
## O que o HEAD já entrega (0.9.91–0.9.512)
