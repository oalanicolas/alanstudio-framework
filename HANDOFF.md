...
**HEAD:** ver `git log -1` — vigente 0.9.1028: o save nomeia o aproveitável que a receita já recusa. Aproveitável no disco não é o save. Sem chave `aproveitável`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1028): **1089 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1028)
