...
**HEAD:** ver `git log -1` — vigente 0.9.890: o ciclo nomeia o smash que a receita já recusa. Smash no disco não é a prioridade. Sem chave `smash`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.890): **951 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.890)
