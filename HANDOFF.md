...
**HEAD:** ver `git log -1` — vigente 0.9.467: o `decisions` do `scan` nomeia o histórico que a receita já recusa. Área no disco não é decisão atual. Sem chave `histórico`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes confirmadas no HEAD (0.9.467):** `python3 -m unittest discover -s tests` → 528 OK.
...
## O que o HEAD já entrega (0.9.91–0.9.467)
