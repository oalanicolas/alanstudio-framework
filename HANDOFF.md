...
**HEAD:** ver `git log -1` — vigente 0.9.941: o `record` nomeia a coleta que a receita já recusa. Coleta no disco não é o engasgo. Sem chave `coleta`. Nomear não mede.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.941): **1002 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.941)
