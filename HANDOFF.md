...
**HEAD:** ver `git log -1` — vigente 0.9.759: o item do craft nomeia o pulo que a pesquisa já recusa. Frase no disco não é o critério. Sem chave `pulo`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.759): **820 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.759)
