...
**HEAD:** ver `git log -1` — vigente 0.9.531: o then do `feel` nomeia a artística que a receita já recusa. Número no disco não é direção. Sem chave `artística`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.531): 592 / 516.
...
## O que o HEAD já entrega (0.9.91–0.9.531)
...
then do `feel` nomeia a artística
que a receita já recusa. A receita
já dizia que os testes não
demonstram qualidade artística; o
then apontava play e calava a
recusa. Número no disco não é
direção. Sem chave `artística`.
Nomear não observa.
