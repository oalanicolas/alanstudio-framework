...
**HEAD:** ver `git log -1` — vigente 0.9.929: o item da observação nomeia a cor que a receita já recusa. Cor no disco não é o estado. Sem chave `cor`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.929): **990 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.929)
