...
**HEAD:** ver `git log -1` — vigente 0.9.523: o `record` do `sfx copy` do acervo nomeia o consumido que a receita já recusa. Recibo no disco não é mix. Sem chave `consumido`. Nomear não ouve.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.523): 584 / 516.
...
## O que o HEAD já entrega (0.9.91–0.9.523)
