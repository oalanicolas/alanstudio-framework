...
**HEAD:** ver `git log -1` — vigente 0.9.639: o `here` do `guide` nomeia o aqui que a receita já recusa. Pasta no disco não é a partida. Sem chave `aqui`. Estar não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.639): **700 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.639)
