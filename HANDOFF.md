...
**HEAD:** ver `git log -1` — vigente 0.9.999: o item do craft nomeia os frames que a pesquisa já recusa. Frames no disco não é a cadeia. Sem chave `frames`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.999): **1060 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.999)
