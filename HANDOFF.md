...
**HEAD:** ver `git log -1` — vigente 0.9.1079: o item do craft nomeia o tópico que a pesquisa já recusa. Tópico no disco não é a cadeia. Sem chave `tópico`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1079): **1140 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1079)
