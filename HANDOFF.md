...
**HEAD:** ver `git log -1` — vigente 0.9.900: o `save` nomeia o foco que a receita já recusa. Foco no disco não é a interrupção. Sem chave `foco`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.900): **961 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.900)
