...
**HEAD:** ver `git log -1` — vigente 0.9.1111: o item do craft nomeia o noodalls que a pesquisa já recusa. Noodalls no disco não é a cadeia. Sem chave `noodalls`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1111): **1172 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1111)
