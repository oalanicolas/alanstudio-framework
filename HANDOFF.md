...
**HEAD:** ver `git log -1` — vigente 0.9.610: o `release_current` do `ship` nomeia o autoriza que a receita já recusa. Arquivo no disco não é outra máquina. Sem chave `autoriza`. Nomear não autoriza.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.610): **671 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.610)
