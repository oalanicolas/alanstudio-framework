...
**HEAD:** ver `git log -1` — vigente 0.9.658: o `gate` nomeia o abandono que o roteiro já recusa. Roteiro no disco não é passagem. Sem chave `abandono`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.658): **719 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.658)
