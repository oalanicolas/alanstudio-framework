...
**HEAD:** ver `git log -1` — vigente 0.9.951: o item do craft nomeia a calibração que a pesquisa já recusa. Calibração no disco não é a cadeia. Sem chave `calibração`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.951): **1012 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.951)
