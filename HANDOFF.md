...
**HEAD:** ver `git log -1` — vigente 0.9.911: o item do craft nomeia os posts que a pesquisa já recusa. Posts no disco não é a cadeia. Sem chave `posts`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.911): **972 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.911)
