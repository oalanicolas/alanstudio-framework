...
**HEAD:** ver `git log -1` — vigente 0.9.741: o `record` nomeia o rebaixar que a receita já recusa. Corte no disco não é o mesmo resultado. Sem chave `rebaixar`. Nomear não mede.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.741): **802 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.741)
