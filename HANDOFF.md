...
**HEAD:** ver `git log -1` — vigente 0.9.974: o `observations` do `feel` nomeia o adequado que a receita já recusa. Adequado no disco não é os saltos. Sem chave `adequado`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.974): **1035 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.974)
