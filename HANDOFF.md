...
**HEAD:** ver `git log -1` — vigente 0.9.1037: o record nomeia o vivo que a receita já recusa. Vivo no disco não é o vazamento. Sem chave `vivo`. Nomear não mede.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1037): **1098 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1037)
