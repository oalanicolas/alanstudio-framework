...
**HEAD:** ver `git log -1` — vigente 0.9.836: o `save` nomeia os controles que a receita já recusa. Partida no disco não é os controles. Sem chave `controles`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.836): **897 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.836)
