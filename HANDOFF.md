...
**HEAD:** ver `git log -1` — vigente 0.9.542: o `art` nomeia o enquadramento que a receita já recusa. Correção no disco não é o conjunto. Sem chave `enquadramento`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.542): **603 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.542)
