...
**HEAD:** ver `git log -1` — vigente 0.9.774: o `observations` do `feel` nomeia o acende que a receita já recusa. Coleta no disco não é o erro. Sem chave `acende`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.774): **835 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.774)
