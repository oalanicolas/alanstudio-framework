...
**HEAD:** ver `git log -1` — vigente 0.9.1088: o content nomeia o Escalar que a receita já recusa. Escalar no disco não é o destino. Sem chave `Escalar`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1088): **1149 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1088)
