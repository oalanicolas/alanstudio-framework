...
**HEAD:** ver `git log -1` — vigente 0.9.664: o `access` nomeia a automática que a receita já recusa. Checagem no disco não é o modo ativo. Sem chave `automática`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.664): **725 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.664)
