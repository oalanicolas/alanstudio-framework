...
**HEAD:** ver `git log -1` — vigente 0.9.1120: o `content` nomeia a geração que a receita já recusa. Geração no disco não é o destino. Sem chave `geração`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1120): **1181 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1120)
