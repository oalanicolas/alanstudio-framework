...
**HEAD:** ver `git log -1` — vigente 0.9.567: o `scripts` do `ship` nomeia a emulação que a receita já recusa. Script no disco não é o dispositivo. Sem chave `emulação`. Nomear não entrega.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.567): **628 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.567)
