...
**HEAD:** ver `git log -1` — vigente 0.9.990: o `observations` do `feel` nomeia os testes que a receita já recusa. Testes no disco não é o feel. Sem chave `testes`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.990): **1051 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.990)
