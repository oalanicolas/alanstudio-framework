...
**HEAD:** ver `git log -1` — vigente 0.9.908: o `save` nomeia a fechada que a receita já recusa. Fechada no disco não é a interrupção. Sem chave `fechada`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.908): **969 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.908)
