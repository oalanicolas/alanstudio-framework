...
**HEAD:** ver `git log -1` — vigente 0.9.749: o `record` nomeia a contraprova que a receita já recusa. Adaptação no disco não é a contraprova. Sem chave `contraprova`. Nomear não mede.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.749): **810 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.749)
