...
**HEAD:** ver `git log -1` — vigente 0.9.636: o `stale` do `ship` nomeia o velho que a receita já recusa. Arquivo no disco não é outra máquina. Sem chave `velho`. Nomear não entrega.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.636): **697 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.636)
