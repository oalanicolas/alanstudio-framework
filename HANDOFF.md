...
**HEAD:** ver `git log -1` — vigente 0.9.1129: o item da observação nomeia a amostra que a receita já recusa. Amostra no disco não é o estado. Sem chave `amostra`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1129): **1190 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1129)
