...
**HEAD:** ver `git log -1` — vigente 0.9.952: o `content` nomeia a superfície que a receita já recusa. Superfície no disco não é as dimensões. Sem chave `superfície`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.952): **1013 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.952)
