...
**HEAD:** ver `git log -1` — vigente 0.9.1043: o feel nomeia o atende que a receita já recusa. Atende no disco não é o feel. Sem chave `atende`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1043): **1104 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1043)
