...
**HEAD:** ver `git log -1` — vigente 0.9.671: o `play` nomeia o verbo que a receita já recusa. Abrir no disco não é o verbo. Sem chave `verbo`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.671): **732 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.671)
