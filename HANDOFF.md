...
**HEAD:** ver `git log -1` — vigente 0.9.422: o `context` nomeia a capacidade que o índice já recusa. Pacote no disco não é comportamento. Sem chave `capacidade`. Nomear não observa.
...
## O que o HEAD já entrega (0.9.91–0.9.422)
...
`context` nomeia a capacidade
que o índice já recusa. O
índice já dizia que o pacote
não certifica capacidade; a
plataforma apontava o arquivo
e calava a recusa. Pacote no
disco não é comportamento. Sem
chave `capacidade`. Nomear
não observa.
