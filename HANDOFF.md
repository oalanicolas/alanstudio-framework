...
**HEAD:** ver `git log -1` — vigente 0.9.925: o `record` nomeia a textura que a receita já recusa. Textura no disco não é o engasgo. Sem chave `textura`. Nomear não mede.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.925): **986 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.925)
