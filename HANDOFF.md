...
**HEAD:** ver `git log -1` — vigente 0.9.621: o `created` do `start` nomeia o executa que a receita já recusa. Pasta no disco não é a partida. Sem chave `executa`. Nomear não executa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.621): **682 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.621)
