...
**HEAD:** ver `git log -1` — vigente 0.9.424: o `guide` nomeia o screenshot que a receita já recusa. Recibo no disco não é peso percebido. Sem chave `screenshot`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes confirmadas no HEAD (0.9.423):** `python3 -m unittest discover -s tests` → 419 OK.
`cd assets/starters/canvas-arcade && npm test` → 509 OK.
Confirmação pendente no 0.9.424.
...
## O que o HEAD já entrega (0.9.91–0.9.424)
