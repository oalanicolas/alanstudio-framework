...
**HEAD:** ver `git log -1` — vigente 0.9.850: o ciclo nomeia o ativo que a receita já recusa. Verbo no disco não é o ativo. Sem chave `ativo`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.850): **911 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.850)
