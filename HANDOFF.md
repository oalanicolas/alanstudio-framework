...
**HEAD:** ver `git log -1` — vigente 0.9.526: o then do `play` nomeia o RNG que a receita já recusa. Endereço no disco não é a simulação. Sem chave `RNG`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.526): 587 / 516.
...
## O que o HEAD já entrega (0.9.91–0.9.526)
...
dizia que aceitar o parâmetro não
prova que ele afeta o RNG; o then
apontava a seed e calava a recusa.
Endereço no disco não é a
simulação. Sem chave `RNG`.
Nomear não observa.
