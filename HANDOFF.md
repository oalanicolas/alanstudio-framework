...
**HEAD:** ver `git log -1` — vigente 0.9.667: o `init` nomeia as referências que o processo já recusa. Runtime no disco não é o contrato. Sem chave `referências`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.667): **728 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.667)
