...
**HEAD:** ver `git log -1` — vigente 0.9.1099: o feel nomeia o estenda que a receita já recusa. Estenda no disco não é o feel. Sem chave `estenda`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1099): **1160 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1099)
