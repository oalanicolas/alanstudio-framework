...
**HEAD:** ver `git log -1` — vigente 0.9.888: o `content` nomeia o ruído que a receita já recusa. Ruído no disco não é as bordas. Sem chave `ruído`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.888): **949 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.888)
