...
**HEAD:** ver `git log -1` — vigente 0.9.1090: o ciclo nomeia o balanceamento que a receita já recusa. Balanceamento no disco não é o teste. Sem chave `balanceamento`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1090): **1151 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1090)
