...
**HEAD:** ver `git log -1` — vigente 0.9.501: o `signals` do review nomeia a partida que o README já recusa. Sinal no disco não é alguém de fora. Sem chave `partida`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.501): 562 / 516.
...
## O que o HEAD já entrega (0.9.91–0.9.501)
