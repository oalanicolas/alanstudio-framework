...
**HEAD:** ver `git log -1` — vigente 0.9.1130: o ciclo nomeia o Compare que a receita já recusa. Compare no disco não é o teste. Sem chave `Compare`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1130): **1191 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1130)
