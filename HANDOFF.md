...
**HEAD:** ver `git log -1` — vigente 0.9.529: o then do `init` nomeia o scaffold que a receita já recusa. Cópia no disco não é a slice. Sem chave `scaffold`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.529): 590 / 516.
...
## O que o HEAD já entrega (0.9.91–0.9.529)
...
then do `init` nomeia o scaffold
que a receita já recusa. A receita
já dizia que scaffold ou cópia que
inicia continua sendo ponto de
partida; o then apontava play e
calava a recusa. Cópia no disco
não é a slice. Sem chave
`scaffold`. Nomear não observa.
