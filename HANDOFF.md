...
**HEAD:** ver `git log -1` — vigente 0.9.933: o `record` nomeia o aquecimento que a receita já recusa. Aquecimento no disco não é o engasgo. Sem chave `aquecimento`. Nomear não mede.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.933): **994 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.933)
