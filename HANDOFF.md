...
**HEAD:** ver `git log -1` — vigente 0.9.578: o `artifact_open` do `ship` nomeia a execução que a receita já recusa. Comando no disco não é outra máquina. Sem chave `execução`. Nomear não entrega.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.578): **639 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.578)
