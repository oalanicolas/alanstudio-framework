...
**HEAD:** ver `git log -1` — vigente 0.9.953: o item da observação nomeia a linguagem que a receita já recusa. Linguagem no disco não é o estado. Sem chave `linguagem`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.953): **1014 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.953)
