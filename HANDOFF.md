...
**HEAD:** ver `git log -1` — vigente 0.9.910: o `observations` do `feel` nomeia o impulso que a receita já recusa. Impulso no disco não é o evento. Sem chave `impulso`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.910): **971 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.910)
