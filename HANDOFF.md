...
**HEAD:** ver `git log -1` — vigente 0.9.646: o `unpacked` do `ship` nomeia o empacote que a receita já recusa. Manifesto no disco não é outra máquina. Sem chave `empacote`. Listar não empacota.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.646): **707 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.646)
