...
**HEAD:** ver `git log -1` — vigente 0.9.1062: o observations do feel nomeia o impedem que a receita já recusa. Impedem no disco não é o feel. Sem chave `impedem`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1062): **1123 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1062)
