...
**HEAD:** ver `git log -1` — vigente 0.9.638: o `named` do `start` nomeia a frase que a receita já recusa. Slug no disco não é o documento. Sem chave `frase`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.638): **699 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.638)
