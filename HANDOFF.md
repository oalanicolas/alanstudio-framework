...
**HEAD:** ver `git log -1` — vigente 0.9.573: o `finding_attachments` do `playtest` nomeia o gravado que a receita já recusa. Arquivo no disco não é a sessão. Sem chave `gravado`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.573): **634 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.573)
