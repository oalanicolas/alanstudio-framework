...
**HEAD:** ver `git log -1` — vigente 0.9.889: o item da observação nomeia o indicador que a receita já recusa. Indicador no disco não é a audição. Sem chave `indicador`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.889): **950 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.889)
