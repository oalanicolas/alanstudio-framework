...
**HEAD:** ver `git log -1` — vigente 0.9.792: o `content` nomeia a opacidade que a receita já recusa. Alpha no disco não é a opacidade. Sem chave `opacidade`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.792): **853 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.792)
