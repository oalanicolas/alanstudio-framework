...
**HEAD:** ver `git log -1` — vigente 0.9.1021: o record nomeia o sobrevivem que a receita já recusa. Sobrevivem no disco não é o vazamento. Sem chave `sobrevivem`. Nomear não mede.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1021): **1082 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1021)
