...
**HEAD:** ver `git log -1` — vigente 0.9.681: a área art_direction nomeia a imagem que o visual já recusa. Imagem no disco não é a aprovação. Sem chave `imagem`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.681): **742 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.681)
