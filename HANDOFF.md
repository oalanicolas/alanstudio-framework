...
**HEAD:** ver `git log -1` — vigente 0.9.1025: o item da observação nomeia os knobs que a receita já recusa. Knobs no disco não é o estado. Sem chave `knobs`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1025): **1086 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1025)
