...
**HEAD:** ver `git log -1` — vigente 0.9.912: o `content` nomeia as bordas que a receita já recusa. Bordas no disco não é as emendas. Sem chave `bordas`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.912): **973 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.912)
