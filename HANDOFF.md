...
**HEAD:** ver `git log -1` — vigente 0.9.484: o `template` do MVP nomeia o valor que a guia já recusa. Molde no disco não é validação. Sem chave `valor`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.484): 545 / 516.
