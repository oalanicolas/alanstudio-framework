...
**HEAD:** ver `git log -1` — vigente 0.9.921: o item da observação nomeia o visível que a receita já recusa. Visível no disco não é a navegação. Sem chave `visível`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.921): **982 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.921)
