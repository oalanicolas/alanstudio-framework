...
**HEAD:** ver `git log -1` — vigente 0.9.870: o `observations` do `feel` nomeia o pack que a receita já recusa. Pack no disco não é a instância. Sem chave `pack`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.870): **931 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.870)
