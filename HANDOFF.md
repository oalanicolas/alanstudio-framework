...
**HEAD:** ver `git log -1` — vigente 0.9.892: o `save` nomeia o processo que a receita já recusa. Processo no disco não é a interrupção. Sem chave `processo`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.892): **953 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.892)
