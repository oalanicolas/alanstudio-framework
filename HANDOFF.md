...
**HEAD:** ver `git log -1` — vigente 0.9.1065: o item da observação nomeia o cede que a receita já recusa. Cede no disco não é o estado. Sem chave `cede`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1065): **1126 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1065)
