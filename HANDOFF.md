...
**HEAD:** ver `git log -1` — vigente 0.9.935: o item do craft nomeia o console que a pesquisa já recusa. Console no disco não é a cadeia. Sem chave `console`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.935): **996 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.935)
