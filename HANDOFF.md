...
**HEAD:** ver `git log -1` — vigente 0.9.325: o compromisso da guarda veste a aposta. Não promove `felt`.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Testes no HEAD (0.9.325):** `python3 -m unittest discover -s tests` → (confirmar).
...
## O que o HEAD já entrega (0.9.91–0.9.325)
...
compromisso da guarda veste a aposta.
O arco do lock já vestia a corrente;
o corpo no hold vestia o descanso.
Não promove `felt`.
