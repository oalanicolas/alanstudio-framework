...
**HEAD:** ver `git log -1` — vigente 0.9.1115: o `feel` nomeia o pulo que a receita já recusa. Pulo no disco não é o feel. Sem chave `pulo`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1115): **1176 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1115)
