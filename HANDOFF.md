...
**HEAD:** ver `git log -1` — vigente 0.9.454: o `genre_mentions[n]` nomeia a mecânica que o mapa já recusa. Campo no disco não é regra do jogo. Sem chave `mecânica`. Nomear não classifica.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes confirmadas no HEAD (0.9.454):** `python3 -m unittest discover -s tests` → 450 OK.
...
## O que o HEAD já entrega (0.9.91–0.9.454)
...
`genre_mentions[n]` nomeia a
mecânica que o mapa já recusa.
O mapa já dizia que nenhuma
regra foi copiada como mecânica
obrigatória; o campo copiava o
valor e calava a recusa. Campo
no disco não é regra do jogo.
Sem chave `mecânica`. Nomear
não classifica.
