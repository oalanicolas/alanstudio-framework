...
**HEAD:** ver `git log -1` — vigente 0.9.742: o `observations` do `feel` nomeia a queda que a receita já recusa. Queda no disco não é o ofício. Sem chave `queda`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.742): **803 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.742)
