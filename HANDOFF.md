...
**HEAD:** ver `git log -1` — vigente 0.9.701: o `craft` nomeia o delegar que o craft já recusa. Confirmação no disco não é delegar. Sem chave `delegar`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.701): **762 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.701)
