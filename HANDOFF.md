...
**HEAD:** ver `git log -1` — vigente 0.9.458: o `artifact` do ship nomeia o editor que a receita já recusa. Manifesto no disco não é o jogo exportado. Sem chave `editor`. Nomear não executa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes confirmadas no HEAD (0.9.458):** `python3 -m unittest discover -s tests` → 454 OK.
...
## O que o HEAD já entrega (0.9.91–0.9.458)
...
`artifact` do ship
nomeia o editor que a
receita já recusa. A receita já
dizia que um teste no editor não
demonstra o jogo exportado; o
manifesto copiava nome e versão
e calava a recusa. Manifesto no
disco não é o jogo exportado.
Sem chave `editor`. Nomear não
executa.
