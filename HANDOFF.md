...
**HEAD:** ver `git log -1` — vigente 0.9.813: o `record` nomeia o culling que a receita já recusa. Grupo no disco não é o culling. Sem chave `culling`. Nomear não mede.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.813): **874 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.813)
