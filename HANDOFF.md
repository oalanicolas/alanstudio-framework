...
**HEAD:** ver `git log -1` — vigente 0.9.307: o relógio nomeia a pausa. Não promove `felt`.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Testes no HEAD (0.9.307):** `python3 -m unittest discover -s tests` → 318 OK.
`cd assets/starters/canvas-arcade && npm test` → 492 OK.
...
## O que o HEAD já entrega (0.9.91–0.9.307)
...
nomeia a pausa. O toque no canto já sentava;
o canvas só mostrava o número e o convite
some a tabela. Não promove `felt`.
