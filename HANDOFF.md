...
**HEAD:** ver `git log -1` — vigente 0.9.1052: o save nomeia o silenciosamente que a receita já recusa. Silenciosamente no disco não é o save. Sem chave `silenciosamente`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1052): **1113 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1052)
