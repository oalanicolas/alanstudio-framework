...
**HEAD:** ver `git log -1` — vigente 0.9.374: o `access` nomeia a legenda que a porta já lê. Texto no disco não é sessão. Sem chave `caption`. Não promove `verified`.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes confirmadas no HEAD (0.9.374):** `python3 -m unittest discover -s tests` → 370 OK.
...
## O que o HEAD já entrega (0.9.91–0.9.374)
