...
**HEAD:** ver `git log -1` — vigente 0.9.684: o sources do continuity nomeia o passo que o next já recusa. Rascunho no disco não é o passo. Sem chave `passo`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.684): **745 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.684)
