...
**HEAD:** ver `git log -1` — vigente 0.9.1010: o ciclo nomeia a arma que a receita já recusa. Arma no disco não é o teste. Sem chave `arma`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1010): **1071 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1010)
