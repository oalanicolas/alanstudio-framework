...
**HEAD:** ver `git log -1` — vigente 0.9.976: o `content` nomeia as portas que a receita já recusa. Portas no disco não é as dimensões. Sem chave `portas`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.976): **1037 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.976)
