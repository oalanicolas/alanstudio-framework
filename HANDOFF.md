...
**HEAD:** ver `git log -1` — vigente 0.9.660: o `bar` nomeia o score que o mapa já recusa. Mapa no disco não é acabamento. Sem chave `score`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.660): **721 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.660)
