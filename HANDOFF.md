...
**HEAD:** ver `git log -1` — vigente 0.9.652: o `template` nomeia o paralelo que a guia já recusa. Guia no disco não é o molde. Sem chave `paralelo`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.652): **713 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.652)
