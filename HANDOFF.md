...
**HEAD:** ver `git log -1` — vigente 0.9.828: o `save` nomeia o idioma que a receita já recusa. Partida no disco não é o idioma. Sem chave `idioma`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.828): **889 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.828)
