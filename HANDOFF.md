...
**HEAD:** ver `git log -1` — vigente 0.9.503: o `local` do `sfx search` nomeia o adapt que a receita já recusa. Stem no disco não é mix. Sem chave `adapt`. Nomear não ouve.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.503): 564 / 516.
...
## O que o HEAD já entrega (0.9.91–0.9.503)
