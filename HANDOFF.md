...
**HEAD:** ver `git log -1` — vigente 0.9.1141: o record nomeia as execuções que a receita já recusa. Execuções no disco não é o vazamento. Sem chave `execuções`. Nomear não mede.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1141): **1202 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1141)
