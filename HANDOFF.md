...
**HEAD:** ver `git log -1` — vigente 0.9.550: o `roles` nomeia o heap que a receita já recusa. Contador no disco não é o mix. Sem chave `heap`. Nomear não ouve.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.550): **611 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.550)
