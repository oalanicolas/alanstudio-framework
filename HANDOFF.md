...
**HEAD:** ver `git log -1` — vigente 0.9.913: o item da observação nomeia a escala que a receita já recusa. Escala no disco não é a leitura. Sem chave `escala`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.913): **974 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.913)
