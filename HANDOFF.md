...
**HEAD:** ver `git log -1` — vigente 0.9.818: o ciclo nomeia a rápida que a receita já recusa. Input no disco não é a queda. Sem chave `rápida`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.818): **879 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.818)
