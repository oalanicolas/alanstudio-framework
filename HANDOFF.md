...
**HEAD:** ver `git log -1` — vigente 0.9.956: o `save` nomeia o migrar que a receita já recusa. Migrar no disco não é o save. Sem chave `migrar`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.956): **1017 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.956)
