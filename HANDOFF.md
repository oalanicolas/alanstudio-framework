...
**HEAD:** ver `git log -1` — vigente 0.9.983: o item do craft nomeia a resposta que a pesquisa já recusa. Resposta no disco não é a cadeia. Sem chave `resposta`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.983): **1044 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.983)
