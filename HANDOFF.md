...
**HEAD:** ver `git log -1` — vigente 0.9.1038: o observations do feel nomeia os liberados que a receita já recusa. Liberados no disco não é o feel. Sem chave `liberados`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1038): **1099 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1038)
