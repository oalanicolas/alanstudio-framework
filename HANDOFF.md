...
**HEAD:** ver `git log -1` — vigente 0.9.957: o `record` nomeia os listeners que a receita já recusa. Listeners no disco não é o vazamento. Sem chave `listeners`. Nomear não mede.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.957): **1018 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.957)
