...
**HEAD:** ver `git log -1` — vigente 0.9.797: o `record` nomeia a grandeza que a receita já recusa. Leitura no disco não é a grandeza. Sem chave `grandeza`. Nomear não mede.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.797): **858 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.797)
