...
**HEAD:** ver `git log -1` — vigente 0.9.539: o `art` nomeia a aparência que a receita já recusa. Importar no disco não é o renderer. Sem chave `aparência`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.539): **600 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.539)
