...
**HEAD:** ver `git log -1` — vigente 0.9.574: o `observations` do `playtest` nomeia o recibo que a receita já recusa. Arquivo no disco não é a sessão. Sem chave `recibo`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.574): **635 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.574)
