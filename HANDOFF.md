...
**HEAD:** ver `git log -1` — vigente 0.9.699: o candidate_curve nomeia o fecho que a receita já recusa. Fecho no disco não é a faixa. Sem chave `fecho`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.699): **760 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.699)
