...
**HEAD:** ver `git log -1` — vigente 0.9.805: o `record` nomeia a gpu que a receita já recusa. PNG no disco não é a GPU. Sem chave `gpu`. Nomear não mede.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.805): **866 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.805)
