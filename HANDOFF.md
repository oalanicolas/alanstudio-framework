...
**HEAD:** ver `git log -1` — vigente 0.9.1007: o item do craft nomeia o apertar que a pesquisa já recusa. Apertar no disco não é a cadeia. Sem chave `apertar`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1007): **1068 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1007)
