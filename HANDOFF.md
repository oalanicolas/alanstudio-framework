...
**HEAD:** ver `git log -1` — vigente 0.9.775: o item do craft nomeia os citados que a pesquisa já recusa. Número no disco não é a fonte. Sem chave `citados`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.775): **836 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.775)
