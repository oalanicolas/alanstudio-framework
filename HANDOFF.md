...
**HEAD:** ver `git log -1` — vigente 0.9.1047: o item do craft nomeia o pobre que a pesquisa já recusa. Pobre no disco não é a cadeia. Sem chave `pobre`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1047): **1108 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1047)
