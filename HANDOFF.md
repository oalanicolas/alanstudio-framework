...
**HEAD:** ver `git log -1` — vigente 0.9.1006: o `observations` do `feel` nomeia o demonstram que a receita já recusa. Demonstram no disco não é o feel. Sem chave `demonstram`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1006): **1067 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1006)
