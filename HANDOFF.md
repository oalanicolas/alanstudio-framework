...
**HEAD:** ver `git log -1` — vigente 0.9.556: o `access` nomeia os pixels que a receita já recusa. Tamanho no disco não é o buffer. Sem chave `pixels`. Nomear não mede.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.556): **617 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.556)
