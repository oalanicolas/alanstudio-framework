...
**HEAD:** ver `git log -1` — vigente 0.9.640: o `truncated` do `origins` nomeia a varredura que o roteiro já recusa. Recorte no disco não é a concessão. Sem chave `varredura`. Parar não concede.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.640): **701 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.640)
