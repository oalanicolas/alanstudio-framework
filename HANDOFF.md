...
**HEAD:** ver `git log -1` — vigente 0.9.399: o convite nomeia o bind que o serve já prende. Bind no disco não é alguém de fora. Sem chave `HOST`. Nomear não observa.
...
## O que o HEAD já entrega (0.9.91–0.9.399)
