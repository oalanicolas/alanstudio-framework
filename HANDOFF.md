...
**HEAD:** ver `git log -1` — vigente 0.9.762: o ciclo nomeia o ofício que a receita já recusa. Porta no disco não é o ofício. Sem chave `ofício`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.762): **823 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.762)
