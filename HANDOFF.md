...
**HEAD:** ver `git log -1` — vigente 0.9.727: o `save` nomeia o derivado que a receita já recusa. Derivado no disco não é o progresso. Sem chave `derivado`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.727): **788 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.727)
