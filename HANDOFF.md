...
**HEAD:** ver `git log -1` — vigente 0.9.625: o `usable` do `runtime` nomeia o binário que a receita já recusa. Node no PATH não é o dispositivo. Sem chave `binário`. Nomear não mede.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.625): **686 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.625)
