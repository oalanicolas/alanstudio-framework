...
**HEAD:** ver `git log -1` — vigente 0.9.634: o `ok` do `sfx verify` nomeia o ouvido que a receita já recusa. Cruzou no disco não é o jogo. Sem chave `ouvido`. Nomear não ouve.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.634): **695 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.634)
