...
**HEAD:** ver `git log -1` — vigente 0.9.928: o `content` nomeia o metro que a receita já recusa. Metro no disco não é as dimensões. Sem chave `metro`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.928): **989 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.928)
