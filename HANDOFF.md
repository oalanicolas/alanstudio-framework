...
**HEAD:** ver `git log -1` — vigente 0.9.1094: o observations nomeia o diferentes que a receita já recusa. Diferentes no disco não é o feel. Sem chave `diferentes`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1094): **1155 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1094)
