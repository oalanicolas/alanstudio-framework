...
**HEAD:** ver `git log -1` — vigente 0.9.873: o item da observação nomeia o pequeno que a receita já recusa. Pequeno no disco não é a leitura. Sem chave `pequeno`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.873): **934 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.873)
