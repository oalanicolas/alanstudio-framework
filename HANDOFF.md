...
**HEAD:** ver `git log -1` — vigente 0.9.732: o `record` nomeia a variável que a receita já recusa. Variável no disco não é a causa. Sem chave `variável`. Nomear não mede.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.732): **793 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.732)
