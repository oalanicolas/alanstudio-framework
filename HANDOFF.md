...
**HEAD:** ver `git log -1` — vigente 0.9.755: o `feel` nomeia o mata que a receita já recusa. Impacto no disco não é a morte. Sem chave `mata`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.755): **816 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.755)
