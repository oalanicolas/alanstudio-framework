...
**HEAD:** ver `git log -1` — vigente 0.9.552: o `sfx export` do acervo nomeia a memória que a receita já recusa. Hash no disco não é o buffer. Sem chave `memória`. Nomear não ouve.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.552): **613 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.552)
