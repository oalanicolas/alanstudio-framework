...
**HEAD:** ver `git log -1` — vigente 0.9.445: o `art` nomeia o volume que a receita já recusa. Lista no disco não é comparação. Sem chave `volume`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes confirmadas no HEAD (0.9.445):** `python3 -m unittest discover -s tests` → 441 OK.
...
## O que o HEAD já entrega (0.9.91–0.9.445)
