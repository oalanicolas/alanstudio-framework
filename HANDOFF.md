...
**HEAD:** ver `git log -1` — vigente 0.9.436: o `scan` nomeia as pessoas que o roteiro já recusa. Área no disco não é censo. Sem chave `pessoas`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes confirmadas no HEAD (0.9.435):** `python3 -m unittest discover -s tests` → 431 OK.
`cd assets/starters/canvas-arcade && npm test` → 509 OK.
Confirmação pendente no 0.9.436.
...
## O que o HEAD já entrega (0.9.91–0.9.436)
