...
**HEAD:** ver `git log -1` — vigente 0.9.1067: o `feel` nomeia os outros que a receita já recusa. Outros no disco não é o feel. Sem chave `outros`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1067): **1128 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1067)
