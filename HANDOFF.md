...
**HEAD:** ver `git log -1` — vigente 0.9.904: o `content` nomeia os gradientes que a receita já recusa. Gradientes no disco não é as emendas. Sem chave `gradientes`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.904): **965 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.904)
