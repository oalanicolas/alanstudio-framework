...
**HEAD:** ver `git log -1` — vigente 0.9.509: a opção `captions` do `access` nomeia o número que a receita já recusa. Número no disco não é mix. Sem chave `número`. Nomear não ouve.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.509): 570 / 516.
...
## O que o HEAD já entrega (0.9.91–0.9.509)
