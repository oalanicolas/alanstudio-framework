...
**HEAD:** ver `git log -1` — vigente 0.9.657: o `craft` nomeia o preciso que o mapa já recusa. Mapa no disco não é ofício observado. Sem chave `preciso`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.657): **718 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.657)
