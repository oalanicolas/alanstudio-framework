...
**HEAD:** ver `git log -1` — vigente 0.9.754: o ciclo nomeia o metralha que a receita já recusa. Cooldown no disco não é a rajada. Sem chave `metralha`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.754): **815 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.754)
