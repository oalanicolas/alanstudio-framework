...
**HEAD:** ver `git log -1` — vigente 0.9.1102: o observations nomeia o ataque que a receita já recusa. Ataque no disco não é o feel. Sem chave `ataque`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1102): **1163 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1102)
