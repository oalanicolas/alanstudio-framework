...
**HEAD:** ver `git log -1` — vigente 0.9.292: o convite não grava o look, a chuva nem o relógio que só vestiu. Não promove `trusted`.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Testes no HEAD:** `python3 -m unittest discover -s tests` → 312 OK.
`cd assets/starters/canvas-arcade && npm test` → 477 OK.
...
## O que o HEAD já entrega (0.9.91–0.9.292)
...
não grava o look, a chuva nem o relógio que
só vestiu. Escolher no painel grava. Não
promove `trusted`.
