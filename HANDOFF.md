...
**HEAD:** ver `git log -1` — vigente 0.9.949: o `record` nomeia o layout que a receita já recusa. Layout no disco não é o engasgo. Sem chave `layout`. Nomear não mede.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.949): **1010 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.949)
