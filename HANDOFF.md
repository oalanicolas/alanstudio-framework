...
**HEAD:** ver `git log -1` — vigente 0.9.1072: o `content` nomeia o inclusive que a receita já recusa. Inclusive no disco não é o destino. Sem chave `inclusive`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1072): **1133 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1072)
