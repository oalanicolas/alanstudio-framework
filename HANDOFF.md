...
**HEAD:** ver `git log -1` — vigente 0.9.1127: o item do craft nomeia a seção que a pesquisa já recusa. Seção no disco não é a cadeia. Sem chave `seção`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1127): **1188 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1127)
