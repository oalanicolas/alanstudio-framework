...
**HEAD:** ver `git log -1` — vigente 0.9.507: o `sfx export` do stem nomeia a invenção que a receita já recusa. Cópia no disco não é mix. Sem chave `invenção`. Nomear não ouve.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.507): 568 / 516.
...
## O que o HEAD já entrega (0.9.91–0.9.507)
