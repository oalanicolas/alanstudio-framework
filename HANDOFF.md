...
**HEAD:** ver `git log -1` — vigente 0.9.1082: o ciclo nomeia os estendidos que a receita já recusa. Estendidos no disco não é o teste. Sem chave `estendidos`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1082): **1143 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1082)
