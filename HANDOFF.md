...
**HEAD:** ver `git log -1` — vigente 0.9.785: o item da observação nomeia o final que a receita já recusa. Acesso no disco não é o recorte. Sem chave `final`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.785): **846 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.785)
