...
**HEAD:** ver `git log -1` — vigente 0.9.977: o item da observação nomeia o menu que a receita já recusa. Menu no disco não é o estado. Sem chave `menu`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.977): **1038 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.977)
