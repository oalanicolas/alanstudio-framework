...
**HEAD:** ver `git log -1` — vigente 0.9.565: o `receipts` do `budget` nomeia a otimização que a receita já recusa. Recibo no disco não é os dois lados. Sem chave `otimização`. Nomear não mede.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.565): **626 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.565)
