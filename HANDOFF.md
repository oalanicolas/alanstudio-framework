...
**HEAD:** ver `git log -1` — vigente 0.9.1015: o item do craft nomeia o multiplicar que a pesquisa já recusa. Multiplicar no disco não é a cadeia. Sem chave `multiplicar`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1015): **1076 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1015)
