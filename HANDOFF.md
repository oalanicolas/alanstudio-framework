...
**HEAD:** ver `git log -1` — vigente 0.9.874: o ciclo nomeia a cápsula que a receita já recusa. Cápsula no disco não é o snapshot. Sem chave `cápsula`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.874): **935 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.874)
