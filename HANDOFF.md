...
**HEAD:** ver `git log -1` — vigente 0.9.1016: o `content` nomeia as sombras que a receita já recusa. Sombras no disco não é o destino. Sem chave `sombras`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1016): **1077 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1016)
