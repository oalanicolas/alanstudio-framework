...
**HEAD:** ver `git log -1` — vigente 0.9.495: o `signals` do next nomeia a conclusão que a receita já recusa. Sinal no disco não é o término. Sem chave `conclusão`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.495): 556 / 516.
...
## O que o HEAD já entrega (0.9.91–0.9.495)
