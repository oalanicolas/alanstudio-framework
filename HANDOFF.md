...
**HEAD:** ver `git log -1` — vigente 0.9.950: o `observations` do `feel` nomeia a integração que a receita já recusa. Integração no disco não é os saltos. Sem chave `integração`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.950): **1011 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.950)
