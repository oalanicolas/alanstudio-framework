...
**HEAD:** ver `git log -1` — vigente 0.9.1097: o item da observação nomeia o draw que a receita já recusa. Draw no disco não é o estado. Sem chave `draw`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1097): **1158 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1097)
