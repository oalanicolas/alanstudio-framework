...
**HEAD:** ver `git log -1` — vigente 0.9.1046: o observations do feel nomeia os Esses que a receita já recusa. Esses no disco não é o feel. Sem chave `Esses`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1046): **1107 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1046)
