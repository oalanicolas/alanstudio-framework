...
**HEAD:** ver `git log -1` — vigente 0.9.430: o `craft` nomeia a escada que a pesquisa já recusa. Pesquisa no disco não é ofício observado. Sem chave `escada`. Nomear não observa.
...
## O que o HEAD já entrega (0.9.91–0.9.430)
