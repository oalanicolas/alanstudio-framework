...
**HEAD:** ver `git log -1` — vigente 0.9.575: o `undeclared` do `origins` nomeia a desconhecida que a guia já recusa. Arquivo no disco não é a concessão. Sem chave `desconhecida`. Nomear não concede.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.575): **636 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.575)
