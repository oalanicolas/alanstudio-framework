...
**HEAD:** ver `git log -1` — vigente 0.9.616: o `expected` do `ship` nomeia o ambiente que a receita já recusa. Pacote no disco não é outra máquina. Sem chave `ambiente`. Nomear não exporta.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.616): **677 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.616)
