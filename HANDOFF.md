...
**HEAD:** ver `git log -1` — vigente 0.9.631: o `reference_present` do `commands` nomeia a carregada que o menu já recusa. Arquivo no disco não é a skill. Sem chave `carregada`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.631): **692 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.631)
