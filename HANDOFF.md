...
**HEAD:** ver `git log -1` — vigente 0.9.1086: o observations nomeia o todas que a receita já recusa. Todas no disco não é o feel. Sem chave `todas`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1086): **1147 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1086)
