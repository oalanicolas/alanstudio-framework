...
**HEAD:** ver `git log -1` — vigente 0.9.879: o item do craft nomeia o citável que a pesquisa já recusa. Citável no disco não é os dados. Sem chave `citável`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.879): **940 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.879)
