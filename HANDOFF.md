...
**HEAD:** ver `git log -1` — vigente 0.9.837: o `record` nomeia as transferências que a receita já recusa. Cópia no disco não é a transferência. Sem chave `transferências`. Nomear não mede.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.837): **898 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.837)
