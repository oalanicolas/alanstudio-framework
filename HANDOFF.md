...
**HEAD:** ver `git log -1` — vigente 0.9.673: o ciclo nomeia o tap que a receita já recusa. Polegar no disco não é o dash. Sem chave `tap`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.673): **734 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.673)
