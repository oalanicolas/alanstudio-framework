...
**HEAD:** ver `git log -1` — vigente 0.9.1012: o `save` nomeia o impossível que a receita já recusa. Impossível no disco não é o save. Sem chave `impossível`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1012): **1073 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1012)
