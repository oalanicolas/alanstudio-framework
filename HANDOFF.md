...
**HEAD:** ver `git log -1` — vigente 0.9.919: o item do craft nomeia as configurações que a pesquisa já recusa. Configurações no disco não é a cadeia. Sem chave `configurações`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.919): **980 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.919)
