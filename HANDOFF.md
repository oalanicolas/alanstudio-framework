...
**HEAD:** ver `git log -1` — vigente 0.9.580: o `invite` do `playtest` nomeia a preferência que a receita já recusa. Convite no disco não é a sessão. Sem chave `preferência`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.580): **641 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.580)
