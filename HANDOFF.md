...
**HEAD:** ver `git log -1` — vigente 0.9.1126: o observations do feel nomeia as condições que a receita já recusa. Condições no disco não é o feel. Sem chave `condições`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1126): **1187 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1126)
