...
**HEAD:** ver `git log -1` — vigente 0.9.989: o `record` nomeia o desmontar que a receita já recusa. Desmontar no disco não é o vazamento. Sem chave `desmontar`. Nomear não mede.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.989): **1050 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.989)
