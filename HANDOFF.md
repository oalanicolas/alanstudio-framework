...
**HEAD:** ver `git log -1` — vigente 0.9.426: o `context` nomeia a API que a receita já recusa. Vocabulário no disco não é runtime. Sem chave `api`. Nomear não observa.
...
## O que o HEAD já entrega (0.9.91–0.9.426)
