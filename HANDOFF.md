...
**HEAD:** ver `git log -1` — vigente 0.9.863: o item do craft nomeia o notar que a pesquisa já recusa. Notar no disco não é a acurácia. Sem chave `notar`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.863): **924 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.863)
