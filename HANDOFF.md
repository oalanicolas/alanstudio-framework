...
**HEAD:** ver `git log -1` — vigente 0.9.1061: o record nomeia o array que a receita já recusa. Array no disco não é o vazamento. Sem chave `array`. Nomear não mede.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1061): **1122 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1061)
