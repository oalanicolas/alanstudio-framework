...
**HEAD:** ver `git log -1` — vigente 0.9.853: o `record` nomeia a borda que a receita já recusa. Borda no disco não é o quadro. Sem chave `borda`. Nomear não mede.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.853): **914 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.853)
