...
**HEAD:** ver `git log -1` — vigente 0.9.546: o `content` nomeia o codificado que a receita já recusa. Arquivo no disco não é o quadro. Sem chave `codificado`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.546): **607 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.546)
