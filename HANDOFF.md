...
**HEAD:** ver `git log -1` — vigente 0.9.689: o item do review nomeia o autorizar que a guia já recusa. Documento no disco não é a autorização. Sem chave `autorizar`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.689): **750 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.689)
