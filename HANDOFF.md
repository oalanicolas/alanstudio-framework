...
**HEAD:** ver `git log -1` — vigente 0.9.1112: o `content` nomeia o necessário que a receita já recusa. Necessário no disco não é o destino. Sem chave `necessário`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1112): **1173 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1112)
