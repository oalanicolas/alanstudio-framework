...
**HEAD:** ver `git log -1` — vigente 0.9.538: o `policy` do `studio_assets` nomeia a herança que o mapa já recusa. Política no disco não é o outro laboratório. Sem chave `herança`. Nomear não ouve.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.538): 599 / 516.
...
## O que o HEAD já entrega (0.9.91–0.9.538)
