...
**HEAD:** ver `git log -1` — vigente 0.9.1107: o feel nomeia o importe que a receita já recusa. Importe no disco não é o feel. Sem chave `importe`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1107): **1168 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1107)
