...
**HEAD:** ver `git log -1` — vigente 0.9.915: o `feel` nomeia a continuidade que a receita já recusa. Continuidade no disco não é a referência. Sem chave `continuidade`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.915): **976 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.915)
