...
**HEAD:** ver `git log -1` — vigente 0.9.886: o `observations` do `feel` nomeia o rebote que a receita já recusa. Rebote no disco não é o impulso. Sem chave `rebote`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.886): **947 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.886)
