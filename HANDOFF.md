...
**HEAD:** ver `git log -1` — vigente 0.9.995: o `feel` nomeia os parâmetros que a receita já recusa. Parâmetros no disco não é o feel. Sem chave `parâmetros`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.995): **1056 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.995)
