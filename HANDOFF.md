...
**HEAD:** ver `git log -1` — vigente 0.9.946: o ciclo nomeia os ossos que a receita já recusa. Ossos no disco não é o teste. Sem chave `ossos`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.946): **1007 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.946)
