...
**HEAD:** ver `git log -1` — vigente 0.9.460: o `non_current_documents[n]` nomeia as linhas que a guia já recusa. Documento no disco não é o jogo. Sem chave `linhas`. Nomear não certifica.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes confirmadas no HEAD (0.9.460):** `python3 -m unittest discover -s tests` → 456 OK.
...
## O que o HEAD já entrega (0.9.91–0.9.460)
...
nomeia as linhas que a
guia já recusa. A guia já
dizia que preencher linhas não
certifica o jogo; o rascunho
copiava o estado e calava a
recusa. Documento no disco não é
o jogo. Sem chave `linhas`. Nomear
não certifica.
