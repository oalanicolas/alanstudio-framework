...
**HEAD:** ver `git log -1` — vigente 0.9.587: o `release` do `ship` nomeia o compartilhar que a receita já recusa. Arquivo no disco não é outra máquina. Sem chave `compartilhar`. Nomear não entrega.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.587): **648 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.587)
