...
**HEAD:** ver `git log -1` — vigente 0.9.876: o `save` nomeia a suspensão que a receita já recusa. Suspensão no disco não é a interrupção. Sem chave `suspensão`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.876): **937 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.876)
