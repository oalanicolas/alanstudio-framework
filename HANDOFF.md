...
**HEAD:** ver `git log -1` — vigente 0.9.1080: o content nomeia o deformar que a receita já recusa. Deformar no disco não é o destino. Sem chave `deformar`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1080): **1141 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1080)
