...
**HEAD:** ver `git log -1` — vigente 0.9.923: o `feel` nomeia as animações que a receita já recusa. Animações no disco não é o dono. Sem chave `animações`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.923): **984 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.923)
