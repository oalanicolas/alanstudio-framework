...
**HEAD:** ver `git log -1` — vigente 0.9.1001: o item da observação nomeia o tremor que a receita já recusa. Tremor no disco não é o estado. Sem chave `tremor`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1001): **1062 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1001)
