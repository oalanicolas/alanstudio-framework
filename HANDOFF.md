...
**HEAD:** ver `git log -1` — vigente 0.9.1045: o record nomeia o sintoma que a receita já recusa. Sintoma no disco não é o vazamento. Sem chave `sintoma`. Nomear não mede.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1045): **1106 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1045)
