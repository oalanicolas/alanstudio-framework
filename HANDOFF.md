...
**HEAD:** ver `git log -1` — vigente 0.9.505: o `matches` do `sfx search` nomeia a triagem que a barra já recusa. Ficha no disco não é mix. Sem chave `triagem`. Nomear não ouve.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.505): 566 / 516.
...
## O que o HEAD já entrega (0.9.91–0.9.505)
