...
**HEAD:** ver `git log -1` — vigente 0.9.1000: o `content` nomeia o estado térmico que a receita já recusa. Térmico no disco não é o destino. Sem chave `térmico`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1000): **1061 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1000)
