...
**HEAD:** ver `git log -1` — vigente 0.9.602: o `used` do `save` nomeia o abre que a receita já recusa. Texto no disco não é a aba. Sem chave `abre`. Nomear não abre.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.602): **663 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.602)
