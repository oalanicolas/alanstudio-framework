...
**HEAD:** ver `git log -1` — vigente 0.9.680: a área vision nomeia a executada que o shape já recusa. Documento no disco não é o experimento. Sem chave `executada`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.680): **741 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.680)
