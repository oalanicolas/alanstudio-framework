...
**HEAD:** ver `git log -1` — vigente 0.9.709: o `created` do `pin` nomeia a substitutibilidade que o processo já recusa. Neutralidade no disco não é a skill. Sem chave `substitutibilidade`. Nomear não substitui.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.709): **770 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.709)
