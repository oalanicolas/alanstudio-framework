...
**HEAD:** ver `git log -1` — vigente 0.9.561: o `verify` nomeia a conectividade que a receita já recusa. Recibo verde não é sessão real. Sem chave `conectividade`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.561): **622 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.561)
