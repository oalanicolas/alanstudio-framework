...
**HEAD:** ver `git log -1` — vigente 0.9.432: o `doctor` nomeia o motor que a ambição já recusa. Convite no then não é runtime. Sem chave `motor`. Nomear não cria.
...
Confirmação pendente no 0.9.432.
...
## O que o HEAD já entrega (0.9.91–0.9.432)
