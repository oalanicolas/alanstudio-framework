...
**HEAD:** ver `git log -1` — vigente 0.9.903: o item do craft nomeia as notícias que a pesquisa já recusa. Notícias no disco não é a cadeia. Sem chave `notícias`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.903): **964 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.903)
