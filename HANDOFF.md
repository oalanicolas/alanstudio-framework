...
**HEAD:** ver `git log -1` — vigente 0.9.685: a área gdd nomeia o brief que o craft já recusa. Contexto no disco não é o brief. Sem chave `brief`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.685): **746 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.685)
