...
**HEAD:** ver `git log -1` — vigente 0.9.859: o `feel` nomeia o intencional que a receita já recusa. Quadros no disco não é o intencional. Sem chave `intencional`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.859): **920 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.859)
