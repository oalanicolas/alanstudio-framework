...
**HEAD:** ver `git log -1` — vigente 0.9.844: o `save` nomeia a acessibilidade que a receita já recusa. Partida no disco não é a acessibilidade. Sem chave `acessibilidade`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.844): **905 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.844)
