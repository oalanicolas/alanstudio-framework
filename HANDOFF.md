...
**HEAD:** ver `git log -1` — vigente 0.9.914: o ciclo nomeia a corrida que a receita já recusa. Corrida no disco não é a prioridade. Sem chave `corrida`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.914): **975 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.914)
