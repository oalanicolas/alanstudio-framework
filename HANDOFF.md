...
**HEAD:** ver `git log -1` — vigente 0.9.858: o ciclo nomeia o hitbox que a receita já recusa. Verbo no disco não é o hitbox. Sem chave `hitbox`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.858): **919 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.858)
