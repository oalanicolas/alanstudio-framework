...
**HEAD:** ver `git log -1` — vigente 0.9.570: o `files` do `content` nomeia os dados que a receita já recusa. Arquivo no disco não é volume. Sem chave `dados`. Nomear não escala.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.570): **631 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.570)
