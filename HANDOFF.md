...
**HEAD:** ver `git log -1` — vigente 0.9.777: o item da observação nomeia a casca que a receita já recusa. Casca no disco não é o verbo. Sem chave `casca`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.777): **838 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.777)
