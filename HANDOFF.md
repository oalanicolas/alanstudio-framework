...
**HEAD:** ver `git log -1` — vigente 0.9.1035: o feel nomeia o Explicite que a receita já recusa. Explicite no disco não é o feel. Sem chave `Explicite`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1035): **1096 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1035)
