...
**HEAD:** ver `git log -1` — vigente 0.9.1069: o `record` nomeia o gerador que a receita já recusa. Gerador no disco não é o vazamento. Sem chave `gerador`. Nomear não mede.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1069): **1130 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1069)
