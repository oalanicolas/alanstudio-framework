...
**HEAD:** ver `git log -1` — vigente 0.9.943: o item do craft nomeia o jogo que a pesquisa já recusa. Jogo no disco não é a cadeia. Sem chave `jogo`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.943): **1004 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.943)
