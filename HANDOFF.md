...
**HEAD:** ver `git log -1` — vigente 0.9.653: a área `qa` do `scan` nomeia a décima que a guia já recusa. Área no disco não é o inventário. Sem chave `décima`. Nomear não inventaria.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.653): **714 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.653)
