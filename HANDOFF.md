...
**HEAD:** ver `git log -1` — vigente 0.9.820: o `save` nomeia a conquista que a receita já recusa. Rótulo no disco não é a conquista. Sem chave `conquista`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.820): **881 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.820)
