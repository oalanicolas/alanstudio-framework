...
**HEAD:** ver `git log -1` — vigente 0.9.698: o play nomeia o arco que a receita já recusa. Arco no disco não é o dash. Sem chave `arco`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.698): **759 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.698)
