...
**HEAD:** ver `git log -1` — vigente 0.9.784: o `content` nomeia o filtro que a receita já recusa. Filtro no disco não é a emenda. Sem chave `filtro`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.784): **845 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.784)
