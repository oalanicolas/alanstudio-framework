...
**HEAD:** ver `git log -1` — vigente 0.9.894: o `observations` do `feel` nomeia as articulações que a receita já recusa. Articulações no disco não é a transição. Sem chave `articulações`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.894): **955 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.894)
