...
**HEAD:** ver `git log -1` — vigente 0.9.1034: o ciclo nomeia o stretch que a receita já recusa. Stretch no disco não é o teste. Sem chave `stretch`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1034): **1095 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1034)
