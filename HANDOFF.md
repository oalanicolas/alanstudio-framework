...
**HEAD:** ver `git log -1` — vigente 0.9.804: o `save` nomeia o efêmero que a receita já recusa. Partida no disco não é o efêmero. Sem chave `efêmero`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.804): **865 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.804)
