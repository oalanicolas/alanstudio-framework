...
**HEAD:** ver `git log -1` — vigente 0.9.1098: o ciclo nomeia os lados que a receita já recusa. Lados no disco não é o teste. Sem chave `lados`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1098): **1159 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1098)
