...
**HEAD:** ver `git log -1` — vigente 0.9.549: o `save` nomeia os contratos que a receita já recusa. Schema no disco não é a história. Sem chave `contratos`. Nomear não confia.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.549): **610 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.549)
