...
**HEAD:** ver `git log -1` — vigente 0.9.563: o `manifests` do `art` nomeia a moeda que a receita já recusa. Manifesto no disco não é comparação. Sem chave `moeda`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.563): **624 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.563)
