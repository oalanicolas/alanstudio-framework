...
**HEAD:** ver `git log -1` — vigente 0.9.746: o ciclo nomeia o alonga que a receita já recusa. Hitstop no disco não é o limite. Sem chave `alonga`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.746): **807 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.746)
