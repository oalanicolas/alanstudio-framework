...
**HEAD:** ver `git log -1` — vigente 0.9.916: o `save` nomeia o temporário que a receita já recusa. Temporário no disco não é a substituição. Sem chave `temporário`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.916): **977 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.916)
