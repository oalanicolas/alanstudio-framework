...
**HEAD:** ver `git log -1` — vigente 0.9.450: o `origins` nomeia os rótulos que o roteiro já recusa. Recibo no disco não é licença. Sem chave `rótulos`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**HEAD anterior + confirmação pendente:** suítes do 0.9.449 (445 / 509). Confirmação 0.9.450 depois das suítes.
...
## O que o HEAD já entrega (0.9.91–0.9.450)
...
`origins` nomeia os rótulos que
o roteiro já recusa. O roteiro
já dizia que sidecar sem os
três rótulos não declara; o
problema copiava o achado e
calava a recusa. Recibo no
disco não é licença. Sem chave
`rótulos`. Nomear não observa.
