...
**HEAD:** ver `git log -1` — vigente 0.9.768: o `content` nomeia o html que a receita já recusa. Página no disco não é o recurso. Sem chave `html`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.768): **829 / 516**.
