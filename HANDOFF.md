...
**HEAD:** ver `git log -1` — vigente 0.9.779: o `feel` nomeia o atraso que a receita já recusa. Atraso no disco não é o peso. Sem chave `atraso`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.779): **840 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.779)
