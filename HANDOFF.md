...
**HEAD:** ver `git log -1` — vigente 0.9.708: o `budget` nomeia as chamadas que a receita já recusa. Chamadas no disco não são o trabalho. Sem chave `chamadas`. Nomear não mede.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.708): **769 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.708)
