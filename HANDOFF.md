...
**HEAD:** ver `git log -1` — vigente 0.9.589: o `at_floor` do `bar` nomeia a otimista que a barra já recusa. Linha no disco não é acabamento. Sem chave `otimista`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.589): **650 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.589)
