...
**HEAD:** ver `git log -1` — vigente 0.9.1058: o ciclo nomeia a parada que a receita já recusa. Parada no disco não é o teste. Sem chave `parada`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1058): **1119 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1058)
