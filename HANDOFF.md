...
**HEAD:** ver `git log -1` — vigente 0.9.733: o item do craft nomeia as métricas que a pesquisa já recusa. Nome no disco não é a métrica. Sem chave `métricas`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.733): **794 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.733)
