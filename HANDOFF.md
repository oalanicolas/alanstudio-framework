...
**HEAD:** ver `git log -1` — vigente 0.9.618: o `declared` do `access` nomeia a fonte que a receita já recusa. Chave no disco não é o modo ativo. Sem chave `fonte`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.618): **679 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.618)
