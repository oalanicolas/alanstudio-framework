...
**HEAD:** ver `git log -1` — vigente 0.9.1092: o save nomeia o conteúdo que a receita já recusa. Conteúdo no disco não é o save. Sem chave `conteúdo`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1092): **1153 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1092)
