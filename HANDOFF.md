...
**HEAD:** ver `git log -1` — vigente 0.9.528: o `fields` do `origins --declare` nomeia a consistência que a receita já recusa. Recibo no disco não é o asset. Sem chave `consistência`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.528): 589 / 516.
...
## O que o HEAD já entrega (0.9.91–0.9.528)
...
`fields` do `origins --declare`
nomeia a consistência que a
receita já recusa. A receita já
dizia que o procedimento não
comprova consistência do gerador;
o declare copiava origem e licença
e calava a recusa. Recibo no disco
não é o asset. Sem chave
`consistência`. Nomear não observa.
