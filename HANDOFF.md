...
**HEAD:** ver `git log -1` — vigente 0.9.702: o `save` nomeia o ensino que a receita já recusa. Hold no disco não é o ensino. Sem chave `ensino`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.702): **763 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.702)
