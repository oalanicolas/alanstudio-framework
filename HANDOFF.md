...
**HEAD:** ver `git log -1` — vigente 0.9.674: o `dimensions[pacing]` do `production_bar` nomeia o interesse que o onboard já recusa. Relógio no disco não é o interesse. Sem chave `interesse`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.674): **735 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.674)
