...
**HEAD:** ver `git log -1` — vigente 0.9.835: o `feel` nomeia a pausa que a receita já recusa. Hitstop no disco não é a pausa. Sem chave `pausa`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.835): **896 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.835)
