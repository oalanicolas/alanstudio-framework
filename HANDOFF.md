...
**HEAD:** ver `git log -1` — vigente 0.9.710: o `observations` do `feel` nomeia o animar que a receita já recusa. Animar no disco não é a regra. Sem chave `animar`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.710): **771 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.710)
