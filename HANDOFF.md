...
**HEAD:** ver `git log -1` — vigente 0.9.1108: o save nomeia as categorias que a receita já recusa. Categorias no disco não é o save. Sem chave `categorias`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1108): **1169 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1108)
