...
**HEAD:** ver `git log -1` — vigente 0.9.1027: o feel nomeia a falta que a receita já recusa. Falta no disco não é o feel. Sem chave `falta`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1027): **1088 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1027)
