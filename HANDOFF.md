...
**HEAD:** ver `git log -1` — vigente 0.9.1019: o feel nomeia a lacuna que a receita já recusa. Lacuna no disco não é o feel. Sem chave `lacuna`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1019): **1080 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1019)
