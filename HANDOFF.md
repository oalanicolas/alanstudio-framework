...
**HEAD:** ver `git log -1` — vigente 0.9.569: o `receipts` do `origins` nomeia a válida que o roteiro já recusa. Arquivo no disco não é a concessão. Sem chave `válida`. Nomear não concede.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.569): **630 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.569)
