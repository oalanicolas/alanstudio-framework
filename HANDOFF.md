...
**HEAD:** ver `git log -1` — vigente 0.9.498: o `tree` do ship nomeia a portabilidade que a receita já recusa. ZIP no disco não é o destino. Sem chave `portabilidade`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.498): 559 / 516.
...
## O que o HEAD já entrega (0.9.91–0.9.498)
