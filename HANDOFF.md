...
**HEAD:** ver `git log -1` — vigente 0.9.543: o `candidate_tally` nomeia o quatro que a receita já recusa. Conta no disco não é achado. Sem chave `quatro`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.543): **604 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.543)
