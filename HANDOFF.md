...
**HEAD:** ver `git log -1` — vigente 0.9.669: o `guide` nomeia os passos que a receita já recusa. Texto no disco não é a partida. Sem chave `passos`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.669): **730 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.669)
