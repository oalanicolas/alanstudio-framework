...
**HEAD:** ver `git log -1` — vigente 0.9.788: o `save` nomeia a transação que a receita já recusa. Alvo no disco não é a transação. Sem chave `transação`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.788): **849 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.788)
