...
**HEAD:** ver `git log -1` — vigente 0.9.537: o `fields` do `record --kind milestone` nomeia o marco que a receita já recusa. Recibo no disco não é a passagem. Sem chave `marco`. Nomear não fecha.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.537): 598 / 516.
...
## O que o HEAD já entrega (0.9.91–0.9.537)
