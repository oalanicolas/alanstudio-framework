...
**HEAD:** ver `git log -1` — vigente 0.9.480: o `initialization` nomeia a pergunta que o roteiro já recusa. Aviso no disco não é espera. Sem chave `pergunta`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** HEAD anterior (0.9.479: 540 / 516) + confirmação pendente.
...
## O que o HEAD já entrega (0.9.91–0.9.480)
