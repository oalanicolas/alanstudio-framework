...
**HEAD:** ver `git log -1` — vigente 0.9.532: o then do `play` sem seed nomeia a observação que a receita já recusa. Recibo no disco não é a sessão. Sem chave `observação`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.532): 593 / 516.
...
## O que o HEAD já entrega (0.9.91–0.9.532)
