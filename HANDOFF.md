...
**HEAD:** ver `git log -1` — vigente 0.9.553: o `ship` nomeia o teto que a receita já recusa. Relato no disco não é a plataforma alvo. Sem chave `teto`. Nomear não entrega.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.553): **614 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.553)
