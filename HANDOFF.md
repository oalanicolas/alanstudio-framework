...
**HEAD:** ver `git log -1` — vigente 0.9.499: o `artifact` do ship nomeia a atual que a receita já recusa. Manifesto no disco não é o HEAD. Sem chave `atual`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.499): 560 / 516.
...
## O que o HEAD já entrega (0.9.91–0.9.499)
