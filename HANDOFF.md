...
**HEAD:** ver `git log -1` — vigente 0.9.806: o `observations` do `feel` nomeia as partículas que a receita já recusa. Partícula no disco não é a consequência. Sem chave `partículas`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.806): **867 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.806)
