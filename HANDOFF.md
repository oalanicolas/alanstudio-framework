...
**HEAD:** ver `git log -1` — vigente 0.9.764: o `save` nomeia a reversão que a receita já recusa. Código no disco não é o save. Sem chave `reversão`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.764): **825 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.764)
