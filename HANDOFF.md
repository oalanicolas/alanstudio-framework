...
**HEAD:** ver `git log -1` — vigente 0.9.852: o `save` nomeia o volume que a receita já recusa. Partida no disco não é o volume. Sem chave `volume`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.852): **913 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.852)
