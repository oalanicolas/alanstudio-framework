...
**HEAD:** ver `git log -1` — vigente 0.9.807: o item do craft nomeia os milissegundos que a pesquisa já recusa. Modelo no disco não é o milissegundo. Sem chave `milissegundos`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.807): **868 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.807)
