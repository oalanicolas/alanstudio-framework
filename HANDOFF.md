...
**HEAD:** ver `git log -1` — vigente 0.9.1110: o observations nomeia o realmente que a receita já recusa. Realmente no disco não é o feel. Sem chave `realmente`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1110): **1171 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1110)
