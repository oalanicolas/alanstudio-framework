...
**HEAD:** ver `git log -1` — vigente 0.9.896: o `content` nomeia as faces que a receita já recusa. Faces no disco não é as emendas. Sem chave `faces`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.896): **957 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.896)
