...
**HEAD:** ver `git log -1` — vigente 0.9.984: o `content` nomeia a orientação que a receita já recusa. Orientação no disco não é o destino. Sem chave `orientação`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.984): **1045 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.984)
