...
**HEAD:** ver `git log -1` — vigente 0.9.869: o `record` nomeia as trajetórias que a receita já recusa. Erro no disco não é as trajetórias. Sem chave `trajetórias`. Nomear não mede.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.869): **930 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.869)
