...
**HEAD:** ver `git log -1` — vigente 0.9.1077: o record nomeia o volta que a receita já recusa. Volta no disco não é o vazamento. Sem chave `volta`. Nomear não mede.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1077): **1138 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1077)
