...
**HEAD:** ver `git log -1` — vigente 0.9.867: o `feel` nomeia o bitmap que a receita já recusa. Tamanho no disco não é o bitmap. Sem chave `bitmap`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.867): **928 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.867)
