...
**HEAD:** ver `git log -1` — vigente 0.9.992: o `content` nomeia a pré-multiplicada que a receita já recusa. Pré-multiplicada no disco não é o destino. Sem chave `pré-multiplicada`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.992): **1053 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.992)
