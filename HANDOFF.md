...
**HEAD:** ver `git log -1` — vigente 0.9.583: o `sources` do `gate` nomeia a lista que o roteiro já recusa. Linha no disco não é passagem. Sem chave `lista`. Nomear não concede.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.583): **644 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.583)
