...
**HEAD:** ver `git log -1` — vigente 0.9.1022: o observations do feel nomeia o demonstrem que a receita já recusa. Demonstrem no disco não é o feel. Sem chave `demonstrem`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1022): **1083 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1022)
