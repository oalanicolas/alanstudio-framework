...
**HEAD:** ver `git log -1` — vigente 0.9.320: o rastro do dash veste o avanço. Não promove `felt`.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Testes no HEAD (0.9.320):** `python3 -m unittest discover -s tests` → 321.
`cd assets/starters/canvas-arcade && npm test` → 498.
...
## O que o HEAD já entrega (0.9.91–0.9.320)
...
rastro do dash veste o avanço.
O corpo já vestia a corrente; o
rastro vestia o descanso. Não
promove `felt`.
