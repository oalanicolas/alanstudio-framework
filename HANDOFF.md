...
**HEAD:** ver `git log -1` — vigente 0.9.849: o item da observação nomeia a repetição que a receita já recusa. Recibo no disco não é a repetição. Sem chave `repetição`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.849): **910 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.849)
