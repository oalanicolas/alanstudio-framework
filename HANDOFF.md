...
**HEAD:** ver `git log -1` — vigente 0.9.520: a opção `ui_scale` do `access` nomeia a tipografia que a receita já recusa. Tipografia no disco não é sessão. Sem chave `tipografia`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.520): 581 / 516.
...
## O que o HEAD já entrega (0.9.91–0.9.520)
