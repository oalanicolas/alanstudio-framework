...
**HEAD:** ver `git log -1` — vigente 0.9.756: o `save` nomeia o curso que a receita já recusa. Preferência no disco não é o curso. Sem chave `curso`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.756): **817 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.756)
