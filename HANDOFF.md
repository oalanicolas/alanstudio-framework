...
**HEAD:** ver `git log -1` — vigente 0.9.554: a opção `captions` do `access` nomeia o mudo que a receita já recusa. Texto no disco não é a partida muda. Sem chave `mudo`. Nomear não verifica.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.554): **615 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.554)
