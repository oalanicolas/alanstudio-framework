...
**HEAD:** ver `git log -1` — vigente 0.9.962: o ciclo nomeia as proporções que a receita já recusa. Proporções no disco não é o teste. Sem chave `proporções`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.962): **1023 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.962)
