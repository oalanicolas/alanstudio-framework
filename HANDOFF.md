...
**HEAD:** ver `git log -1` — vigente 0.9.875: o `feel` nomeia a repintura que a receita já recusa. Repintura no disco não é a apresentação. Sem chave `repintura`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.875): **936 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.875)
