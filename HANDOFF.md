...
**HEAD:** ver `git log -1` — vigente 0.9.1106: o ciclo nomeia o explícito que a receita já recusa. Explícito no disco não é o teste. Sem chave `explícito`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1106): **1167 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1106)
