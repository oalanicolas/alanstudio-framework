...
**HEAD:** ver `git log -1` — vigente 0.9.651: o `next` nomeia a rodada que o fluxo já recusa. Pedido no disco não é o recorte. Sem chave `rodada`. Nomear não executa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.651): **712 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.651)
