...
**HEAD:** ver `git log -1` — vigente 0.9.1084: o save nomeia os saves que a receita já recusa. Saves no disco não é o save. Sem chave `saves`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1084): **1145 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1084)
