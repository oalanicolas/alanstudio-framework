...
**HEAD:** ver `git log -1` — vigente 0.9.927: o item do craft nomeia os builds que a pesquisa já recusa. Builds no disco não é a cadeia. Sem chave `builds`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.927): **988 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.927)
