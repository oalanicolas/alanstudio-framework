...
**HEAD:** ver `git log -1` — vigente 0.9.1105: o item da observação nomeia o estilhaço que a receita já recusa. Estilhaço no disco não é o estado. Sem chave `estilhaço`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1105): **1166 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1105)
