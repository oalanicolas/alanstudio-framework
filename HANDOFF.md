...
**HEAD:** ver `git log -1` — vigente 0.9.739: o `feel` nomeia o freeze que a receita já recusa. Freeze no disco não é o perdão. Sem chave `freeze`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.739): **800 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.739)
