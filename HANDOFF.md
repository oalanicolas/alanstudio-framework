...
**HEAD:** ver `git log -1` — vigente 0.9.1116: o `save` nomeia a única que a receita já recusa. Única no disco não é o save. Sem chave `única`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1116): **1177 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1116)
