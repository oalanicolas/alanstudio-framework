...
**HEAD:** ver `git log -1` — vigente 0.9.1057: o item da observação nomeia o ficam que a receita já recusa. Ficam no disco não é o estado. Sem chave `ficam`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1057): **1118 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1057)
