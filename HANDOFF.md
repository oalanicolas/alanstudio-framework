...
**HEAD:** ver `git log -1` — vigente 0.9.1114: o ciclo nomeia a diferença que a receita já recusa. Diferença no disco não é o teste. Sem chave `diferença`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1114): **1175 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1114)
