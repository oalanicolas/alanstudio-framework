...
**HEAD:** ver `git log -1` — vigente 0.9.1089: o item da observação nomeia o hex que a receita já recusa. Hex no disco não é o estado. Sem chave `hex`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1089): **1150 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1089)
