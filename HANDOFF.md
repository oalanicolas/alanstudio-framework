...
**HEAD:** ver `git log -1` — vigente 0.9.1054: o observations do feel nomeia o reproduza que a receita já recusa. Reproduza no disco não é o feel. Sem chave `reproduza`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1054): **1115 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1054)
