...
**HEAD:** ver `git log -1` — vigente 0.9.767: o item do craft nomeia o fingir que a pesquisa já recusa. Lista no disco não é o critério. Sem chave `fingir`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.767): **828 / 516**.
