...
**HEAD:** ver `git log -1` — vigente 0.9.697: o git nomeia os desatualizados que o processo já recusa. Snapshot no disco não é o estado. Sem chave `desatualizados`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.697): **758 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.697)
