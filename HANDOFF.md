...
**HEAD:** ver `git log -1` — vigente 0.9.688: a área runbook nomeia a inicialização que o processo já recusa. Servidor no disco não é o documento. Sem chave `inicialização`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.688): **749 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.688)
