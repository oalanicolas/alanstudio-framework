...
**HEAD:** ver `git log -1` — vigente 0.9.1138: o ciclo nomeia o Meça que a receita já recusa. Meça no disco não é o teste. Sem chave `Meça`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1138): **1199 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1138)
