...
**HEAD:** ver `git log -1` — vigente 0.9.786: o ciclo nomeia o escrever que a receita já recusa. Recado no disco não é o verbo. Sem chave `escrever`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.786): **847 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.786)
