...
**HEAD:** ver `git log -1` — vigente 0.9.1029: o record nomeia o descarte que a receita já recusa. Descarte no disco não é o vazamento. Sem chave `descarte`. Nomear não mede.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1029): **1090 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1029)
