...
**HEAD:** ver `git log -1` — vigente 0.9.1024: o content nomeia as montadas que a receita já recusa. Montadas no disco não é o destino. Sem chave `montadas`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1024): **1085 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1024)
