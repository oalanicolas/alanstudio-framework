...
**HEAD:** ver `git log -1` — vigente 0.9.931: o `feel` nomeia o dono que a receita já recusa. Dono no disco não é a pose. Sem chave `dono`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.931): **992 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.931)
