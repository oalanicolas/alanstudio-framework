...
**HEAD:** ver `git log -1` — vigente 0.9.780: o `save` nomeia a exceção que a receita já recusa. Dado no disco não é a exceção. Sem chave `exceção`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.780): **841 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.780)
