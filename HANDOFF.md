...
**HEAD:** ver `git log -1` — vigente 0.9.1020: o save nomeia o reproduzir que a receita já recusa. Reproduzir no disco não é o save. Sem chave `reproduzir`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1020): **1081 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1020)
