...
**HEAD:** ver `git log -1` — vigente 0.9.819: o `feel` nomeia o stutter que a receita já recusa. Preset no disco não é o stutter. Sem chave `stutter`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.819): **880 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.819)
