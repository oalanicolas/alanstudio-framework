...
**HEAD:** ver `git log -1` — vigente 0.9.872: o `content` nomeia o autoral que a receita já recusa. Autoral no disco não é a preparação. Sem chave `autoral`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.872): **933 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.872)
