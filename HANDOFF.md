...
**HEAD:** ver `git log -1` — vigente 0.9.802: o ciclo nomeia o tick que a receita já recusa. Tick no disco não é o verbo. Sem chave `tick`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.802): **863 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.802)
