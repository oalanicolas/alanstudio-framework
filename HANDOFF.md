...
**HEAD:** ver `git log -1` — vigente 0.9.518: a opção `assist` do `access` nomeia o oculto que a receita já recusa. Oculto no disco não é sessão. Sem chave `oculto`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.518): 579 / 516.
...
## O que o HEAD já entrega (0.9.91–0.9.518)
