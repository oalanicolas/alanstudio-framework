...
**HEAD:** ver `git log -1` — vigente 0.9.1059: o feel nomeia o cobre que a receita já recusa. Cobre no disco não é o feel. Sem chave `cobre`. Nomear não observa.
**Goal:** ativo. Não marcar complete. AAA fácil ainda não está provado.

**Suítes:** confirmadas no HEAD (0.9.1059): **1120 / 516**.
...
## O que o HEAD já entrega (0.9.91–0.9.1059)
