...
- Escalar um módulo inteiro pode deformar ferragens e sombras. Se a receita recusa que escalar o módulo preserve as ferragens, o `content` nomeia as ferragens que a receita já recusa. Módulo no disco não é a ferragem. Sem chave `ferragens`. Repetições montadas
  ...
  densidade. Escolha cortes pela silhueta projetada na câmera real, inclusive fora da grade. Se a receita recusa que as faixas disjuntas preservem a oclusão, o `content` nomeia a oclusão que a receita já recusa. Faixa no disco não é a oclusão. Sem chave `oclusão`.
