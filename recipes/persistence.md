...
- **Persistente de preferência:** volume, controles, acessibilidade, idioma. Vive
  separado do progresso, porque sobrevive a apagar a partida. Se a receita recusa que apagar a partida apague o idioma, o `save` nomeia o idioma que a receita já recusa. Partida no disco não é o idioma. Sem chave `idioma`. Se a receita recusa que apagar a partida apague os controles, o `save` nomeia os controles que a receita já recusa. Partida no disco não é os controles. Sem chave `controles`.
