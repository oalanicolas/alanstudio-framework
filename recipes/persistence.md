...
- **Efêmero:** existe só durante a partida e é reconstruído ao iniciar. Se a receita recusa que o efêmero seja o save, o `save` nomeia o efêmero que a receita já recusa. Partida no disco não é o efêmero. Sem chave `efêmero`.
