...
1. Consulte o [playground](https://games.alanicolas.com/) e o acervo local.
   ...
   Se a receita recusa que query no disco seja aba fechada, o `warned` do `save` nomeia a query que a receita já recusa. Endereço no disco não é a aba. Sem chave `query`.
