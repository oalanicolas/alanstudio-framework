...
- Nomeie a grandeza medida: simulação isolada, duração de callback, intervalo de RAF,
  ...
  Leituras GPU, escrita de PNG e tempo simulado alteram a própria execução. Se a receita recusa que a leitura GPU deixe a execução intacta, o `record` nomeia a gpu que a receita já recusa. PNG no disco não é a GPU. Sem chave `gpu`.
...
- Agrupamento excessivo pode anular o culling. Se a receita recusa que o agrupamento preserve o culling, o `record` nomeia o culling que a receita já recusa. Grupo no disco não é o culling. Sem chave `culling`. Compare grupos espaciais, instâncias e
...
- Copiar um mapa grande ou compor estático/dinâmico pode custar mais que redesenhar
  o conteúdo visível. Se a receita recusa que copiar o mapa custe menos que redesenhar, o `record` nomeia o mapa que a receita já recusa. Cópia no disco não é o visível. Sem chave `mapa`. Conte transferências, sincronização e submissões efetivas. Se a receita recusa que copiar o mapa conte as submissões, o `record` nomeia as submissões que a receita já recusa. Cópia no disco não é a submissão. Sem chave `submissões`. Se a receita recusa que copiar o mapa conte as transferências, o `record` nomeia as transferências que a receita já recusa. Cópia no disco não é a transferência. Sem chave `transferências`. Se a receita recusa que copiar o mapa conte a sincronização, o `record` nomeia a sincronização que a receita já recusa. Cópia no disco não é a sincronização. Sem chave `sincronização`. Se a receita recusa que repetir a borda prove o quadro, o `record` nomeia a borda que a receita já recusa. Borda no disco não é o quadro. Sem chave `borda`. Se a receita recusa que medir a taxa prove as consultas, o `record` nomeia as consultas que a receita já recusa. Taxa no disco não é as consultas. Sem chave `consultas`. Se a receita recusa que medir o erro prove as trajetórias, o `record` nomeia as trajetórias que a receita já recusa. Erro no disco não é as trajetórias. Sem chave `trajetórias`. Se a receita recusa que o reflow prove o engasgo, o `record` nomeia o reflow que a receita já recusa. Reflow no disco não é o engasgo. Sem chave `reflow`. Se a receita recusa que a coleta de lixo prove o engasgo, o `record` nomeia o lixo que a receita já recusa. Lixo no disco não é o engasgo. Sem chave `lixo`. Se a receita recusa que a primeira compilação de shader prove o engasgo, o `record` nomeia o shader que a receita já recusa. Shader no disco não é o engasgo. Sem chave `shader`. Se a receita recusa que a decodificação de recurso prove o engasgo, o `record` nomeia a decodificação que a receita já recusa. Decodificação no disco não é o engasgo. Sem chave `decodificação`. Se a receita recusa que a mudança de cena prove o engasgo, o `record` nomeia a cena que a receita já recusa. Cena no disco não é o engasgo. Sem chave `cena`. Se a receita recusa que o carregamento prove o engasgo, o `record` nomeia o carregamento que a receita já recusa. Carregamento no disco não é o engasgo. Sem chave `carregamento`. Se a receita recusa que a criação de textura prove o engasgo, o `record` nomeia a textura que a receita já recusa. Textura no disco não é o engasgo. Sem chave `textura`. Se a receita recusa que o caminho que ainda não aqueceu prove o engasgo, o `record` nomeia o aquecimento que a receita já recusa. Aquecimento no disco não é o engasgo. Sem chave `aquecimento`. Se a receita recusa que a alocação e coleta prove o engasgo, o `record` nomeia a coleta que a receita já recusa. Coleta no disco não é o engasgo. Sem chave `coleta`. Se a receita recusa que o layout prove o engasgo, o `record` nomeia o layout que a receita já recusa. Layout no disco não é o engasgo. Sem chave `layout`. Se a receita recusa que os listeners provem o vazamento, o `record` nomeia os listeners que a receita já recusa. Listeners no disco não é o vazamento. Sem chave `listeners`. Se a receita recusa que os timers provem o vazamento, o `record` nomeia os timers que a receita já recusa. Timers no disco não é o vazamento. Sem chave `timers`. Se a receita recusa que os loops provem o vazamento, o `record` nomeia os loops que a receita já recusa. Loops no disco não é o vazamento. Sem chave `loops`. Se a receita recusa que as conexões provem o vazamento, o `record` nomeia as conexões que a receita já recusa. Conexões no disco não é o vazamento. Sem chave `conexões`. Se a receita recusa que o desmontar prove o vazamento, o `record` nomeia o desmontar que a receita já recusa. Desmontar no disco não é o vazamento. Sem chave `desmontar`. Se a receita recusa que o ciclo de vida prove o vazamento, o `record` nomeia a vida que a receita já recusa. Vida no disco não é o vazamento. Sem chave `vida`. Se a receita recusa que o consumo prove o vazamento, o `record` nomeia o consumo que a receita já recusa. Consumo no disco não é o vazamento. Sem chave `consumo`. Se a receita recusa que as texturas provem o vazamento, o `record` nomeia as texturas que a receita já recusa. Texturas no disco não é o vazamento. Sem chave `texturas`. Se a receita recusa que o sobrevivem prove o vazamento, o `record` nomeia o sobrevivem que a receita já recusa. Sobrevivem no disco não é o vazamento. Sem chave `sobrevivem`.
