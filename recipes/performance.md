...
- Copiar um mapa grande ou compor estático/dinâmico pode custar mais que redesenhar
  o conteúdo visível. Se a receita recusa que copiar o mapa custe menos que redesenhar, o `record` nomeia o mapa que a receita já recusa. Cópia no disco não é o visível. Sem chave `mapa`. Conte transferências, sincronização e submissões efetivas.
