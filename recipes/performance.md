...
- Copiar um mapa grande ou compor estático/dinâmico pode custar mais que redesenhar
  o conteúdo visível. Se a receita recusa que copiar o mapa custe menos que redesenhar, o `record` nomeia o mapa que a receita já recusa. Cópia no disco não é o visível. Sem chave `mapa`. Conte transferências, sincronização e submissões efetivas. Se a receita recusa que copiar o mapa conte as submissões, o `record` nomeia as submissões que a receita já recusa. Cópia no disco não é a submissão. Sem chave `submissões`. Se a receita recusa que copiar o mapa conte as transferências, o `record` nomeia as transferências que a receita já recusa. Cópia no disco não é a transferência. Sem chave `transferências`. Se a receita recusa que copiar o mapa conte a sincronização, o `record` nomeia a sincronização que a receita já recusa. Cópia no disco não é a sincronização. Sem chave `sincronização`.
