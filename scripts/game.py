...
def invite_page(project):
    ...
    return (
        ...
        "Número na faixa não preenche os quatro nomes. Copiar não\n"
        "grava. Grave só se os quatro tiverem texto. Esqueleto vazio\n"
        "não é achado. Se a partida deixou last-run, o serve anexa o\n"
        "candidato ao lado do markdown. Anexo não é sessão observada.\n"
        "Gravado não sobe pacing.\n"
