...
| `pacing` | `slice` | `shippable`: a curva foi observada com quem nunca viu o jogo — a prática é orbe-só e o campo a marca; guardar recupera o intervalo e o campo marca a folga; a sessão relata never_banked e erro repetido na simulação; `/?invite=1` some a tabela de comandos; com last-run, `/?invite=1&seed=<n>` abre essa partida; depois do fim a página oferece os quatro nomes para copiar ou gravar; copiar não grava; gravado não fecha a curva; a curva com quem nunca viu o jogo continua pendente |
