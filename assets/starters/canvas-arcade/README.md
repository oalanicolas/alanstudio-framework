...
| `state_trust` | `slice` | `shippable`: interrupção abrupta real — aba fechada — além do teste de dado inválido; `pagehide` e perda de foco já descarregam o save; a abertura lê `lastSeed`, a última pontuação e o recorde; com tela o fim volta à porta; repetir a última não é o tick interrompido |
