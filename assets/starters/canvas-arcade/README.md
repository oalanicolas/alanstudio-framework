...
o recorde e repetir a última seed. Sem tela o headless começa
jogando. Repetir não é o tick interrompido.
...
| `state_trust` | `slice` | `shippable`: interrupção abrupta real — aba fechada — além do teste de dado inválido; `pagehide` e perda de foco já descarregam o save; a abertura lê `lastSeed` e o recorde; repetir a última não é o tick interrompido |
