...
| jogador | `#f2f4f8` / `#ffffff` | `PALETTES.*.player` — o corpo em descanso; o coil do avanço, o coil da guarda, o compromisso da guarda e o avanço vestem a corrente; a recuperação veste o apoio, não o orbe |
