...
- Remapeamento de ações (`bindings`); a página expõe as seis ações do teclado e a tabela `#commands` nomeia as teclas vigentes — toque e controle ficam no sufixo e não entram no remap; a escuta come a tecla que escolhe o verbo; persistir no stub não é sessão observada
...
- Knobs da casca (select, faixa, caixa) vestem o look e têm foco visível — token no disco não é sessão observada
