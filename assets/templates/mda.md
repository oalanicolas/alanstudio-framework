...
Status: rascunho. Hipóteses não testadas. Fonte: [brief/GDD e direção do usuário].
Pode ser uma seção do GDD; não mantenha cópia paralela desta análise.
...
- Efeito indesejado: [ex.: tensão virar frustração ou escolha virar opção dominante].
...
## Registro após observar

- Resultado: não executado.
- Evidência: [localizador, versão, observador e condições].
- Observação literal: [acontecimento ou relato; separar da interpretação].
- Interpretação e alternativa: [explicação com grau de incerteza].
- Decisão: [manter, ajustar ou rejeitar hipótese; efeitos no GDD].
- Próxima ação e responsável pela revisão: [preencher].
