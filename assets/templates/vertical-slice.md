...
Status do plano: rascunho. Execução/avaliação: não realizadas neste template.
Fontes canônicas: [GDD, PRD, TDD e experimentos anteriores].
...
- Comandos técnicos: [validadores existentes e ordem necessária].
- Percurso em movimento: [condições equivalentes para comparação].
- Playtest: [hipótese, observador/jogador, procedimento e sinais relevantes].
...
- Aprovação do usuário: [somente se efetivamente concedida; avaliação do agente identificada como tal].
